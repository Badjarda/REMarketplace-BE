package daml.daml.finance.settlement.factory;
...
public final class Factory extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("ea5a2fa6a1df87c3279c4672835e49813545489febd9d5f9e076ca36db837b33", "Daml.Finance.Settlement.Factory", "Factory");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Factory> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.daml.finance.settlement.factory.Factory",
  ...
  public Factory(String provider, Set<String> observers) {
  ...
  public String toString() {
    return String.format("daml.daml.finance.settlement.factory.Factory(%s, %s)", this.provider,
        this.observers);
  }
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Factory> implements Exercises<ExerciseCommand> {
    ...
    public daml.daml.finance.interface$.settlement.factory.Factory.ContractId toInterface(
        daml.daml.finance.interface$.settlement.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new daml.daml.finance.interface$.settlement.factory.Factory.ContractId(this.contractId);
    }

    public static ContractId unsafeFromInterface(
        daml.daml.finance.interface$.settlement.factory.Factory.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.daml.finance.interface$.settlement.factory.Factory.CreateAnd toInterface(
        daml.daml.finance.interface$.settlement.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new daml.daml.finance.interface$.settlement.factory.Factory.CreateAnd(COMPANION, this.createArguments);
    }
  }
}
