package daml.daml.finance.instrument.token.factory;
...
public final class Factory extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("82633b0841153f2965240f464315973d493dce7f4b721167137b004c8ff5e4cf", "Daml.Finance.Instrument.Token.Factory", "Factory");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Factory> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.daml.finance.instrument.token.factory.Factory",
  ...
  public static Update<Created<ContractId>> create(String provider,
  ...
  public static JsonLfDecoder<Factory> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("provider", "observers"), name -> {
          switch (name) {
  ...
  public String toString() {
    return String.format("daml.daml.finance.instrument.token.factory.Factory(%s, %s)",
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Factory> implements Exercises<ExerciseCommand> {
    ...
    public daml.daml.finance.interface$.instrument.token.factory.Factory.ContractId toInterface(
        daml.daml.finance.interface$.instrument.token.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new daml.daml.finance.interface$.instrument.token.factory.Factory.ContractId(this.contractId);
    }
    ...
    public static ContractId unsafeFromInterface(
        daml.daml.finance.interface$.instrument.token.factory.Factory.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.daml.finance.interface$.instrument.token.factory.Factory.CreateAnd toInterface(
        daml.daml.finance.interface$.instrument.token.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new daml.daml.finance.interface$.instrument.token.factory.Factory.CreateAnd(COMPANION, this.createArguments);
    }
