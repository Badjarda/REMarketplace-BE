...
public final class Factory extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("26b39500d110bf1f69fc9d84e2ec281dd9a62fbdf35369e7321d5b30ccc46a97", "Daml.Finance.Lifecycle.Election", "Factory");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Factory> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.daml.finance.lifecycle.election.Factory",
  ...
  public String toString() {
    return String.format("daml.daml.finance.lifecycle.election.Factory(%s, %s)", this.provider,
        this.observers);
  }
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Factory> implements Exercises<ExerciseCommand> {
    ...
    public daml.daml.finance.interface$.lifecycle.election.factory.Factory.ContractId toInterface(
        daml.daml.finance.interface$.lifecycle.election.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new daml.daml.finance.interface$.lifecycle.election.factory.Factory.ContractId(this.contractId);
    }
    ...
    public static ContractId unsafeFromInterface(
        daml.daml.finance.interface$.lifecycle.election.factory.Factory.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.daml.finance.interface$.lifecycle.election.factory.Factory.CreateAnd toInterface(
        daml.daml.finance.interface$.lifecycle.election.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new daml.daml.finance.interface$.lifecycle.election.factory.Factory.CreateAnd(COMPANION, this.createArguments);
    }
