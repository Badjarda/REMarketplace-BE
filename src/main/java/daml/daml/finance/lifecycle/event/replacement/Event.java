package daml.daml.finance.lifecycle.event.replacement;
...
public final class Event extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("26b39500d110bf1f69fc9d84e2ec281dd9a62fbdf35369e7321d5b30ccc46a97", "Daml.Finance.Lifecycle.Event.Replacement", "Event");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Event> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.daml.finance.lifecycle.event.replacement.Event",
  ...
  public Event(Set<String> providers, Id id, String description, Instant effectiveTime,
      InstrumentKey targetInstrument, List<Quantity<InstrumentKey, BigDecimal>> perUnitReplacement,
  ...
  public static Update<Created<ContractId>> create(Set<String> providers, Id id, String description,
      Instant effectiveTime, InstrumentKey targetInstrument,
      List<Quantity<InstrumentKey, BigDecimal>> perUnitReplacement, Set<String> observers) {
    return new Event(providers, id, description, effectiveTime, targetInstrument,
        perUnitReplacement, observers).create();
  }
  ...
  public DamlRecord toValue() {
    ...
    fields.add(new DamlRecord.Field("perUnitReplacement", this.perUnitReplacement.stream().collect(DamlCollectors.toDamlList(v$0 -> v$0.toValue(v$1 -> v$1.toValue(),
        v$2 -> new Numeric(v$2))))));
  ...
  private static ValueDecoder<Event> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new Event(providers, id, description, effectiveTime, targetInstrument,
          perUnitReplacement, observers);
    } ;
  }

  public static JsonLfDecoder<Event> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("providers", "id", "description", "effectiveTime", "targetInstrument", "perUnitReplacement", "observers"), name -> {
          switch (name) {
            ...
            case "perUnitReplacement": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(5, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.list(daml.daml.finance.interface$.types.common.types.Quantity.jsonDecoder(daml.daml.finance.interface$.types.common.types.InstrumentKey.jsonDecoder(), com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.numeric(10))));
            case "observers": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(6, daml.da.set.types.Set.jsonDecoder(com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.party));
            default: return null;
          }
        }
        , (Object[] args) -> new Event(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3]), JsonLfDecoders.cast(args[4]), JsonLfDecoders.cast(args[5]), JsonLfDecoders.cast(args[6])));
  }
  ...
  public int hashCode() {
    return Objects.hash(this.providers, this.id, this.description, this.effectiveTime,
        this.targetInstrument, this.perUnitReplacement, this.observers);
  }

  @Override
  public String toString() {
    return String.format("daml.daml.finance.lifecycle.event.replacement.Event(%s, %s, %s, %s, %s, %s, %s)",
        this.providers, this.id, this.description, this.effectiveTime, this.targetInstrument,
        this.perUnitReplacement, this.observers);
  }
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Event> implements Exercises<ExerciseCommand> {
    ...
    public daml.daml.finance.interface$.lifecycle.event.replacement.Event.ContractId toInterface(
        daml.daml.finance.interface$.lifecycle.event.replacement.Event.INTERFACE_ interfaceCompanion) {
      return new daml.daml.finance.interface$.lifecycle.event.replacement.Event.ContractId(this.contractId);
    }
    ...
    public static ContractId unsafeFromInterface(
        daml.daml.finance.interface$.lifecycle.event.replacement.Event.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.daml.finance.interface$.lifecycle.event.replacement.Event.CreateAnd toInterface(
        daml.daml.finance.interface$.lifecycle.event.replacement.Event.INTERFACE_ interfaceCompanion) {
      return new daml.daml.finance.interface$.lifecycle.event.replacement.Event.CreateAnd(COMPANION, this.createArguments);
    }
