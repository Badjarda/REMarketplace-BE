package daml.daml.finance.lifecycle.rule.replacement;
...
public final class Rule extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("26b39500d110bf1f69fc9d84e2ec281dd9a62fbdf35369e7321d5b30ccc46a97", "Daml.Finance.Lifecycle.Rule.Replacement", "Rule");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Rule> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.daml.finance.lifecycle.rule.replacement.Rule",
  ...
  public String toString() {
    return String.format("daml.daml.finance.lifecycle.rule.replacement.Rule(%s, %s, %s, %s, %s)",
