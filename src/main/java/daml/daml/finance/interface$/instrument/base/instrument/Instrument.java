...
public final class Instrument {
  public static final Identifier TEMPLATE_ID = new Identifier("0337d95cbc03800a2dea97d4d6edad768f08b69e119abf4729f77705965e0f58", "Daml.Finance.Interface.Instrument.Base.Instrument", "Instrument");

  public static final Choice<Instrument, Remove, Unit> CHOICE_Remove = 
  ...
  public static final class INTERFACE_ extends InterfaceCompanion<Instrument, ContractId, View> {
    INTERFACE_() {
      super(
            "daml.daml.finance.interface$.instrument.base.instrument.Instrument", Instrument.TEMPLATE_ID, ContractId::new, View.valueDecoder(),
            View::fromJson,List.of(CHOICE_Remove, CHOICE_GetView, CHOICE_Archive));
    }
  }
}
