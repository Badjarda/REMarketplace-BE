...
import daml.daml.finance.interface$.instrument.token.instrument.Instrument;
...
public final class Factory {
  public static final Identifier TEMPLATE_ID = new Identifier("ed0ddc9629bb602042cfa07ad9cab51df97016b81309db004c9d25ea8d6fbc9d", "Daml.Finance.Interface.Instrument.Token.Factory", "Factory");
  ...
  public static final class INTERFACE_ extends InterfaceCompanion<Factory, ContractId, View> {
    INTERFACE_() {
      super(
            "daml.daml.finance.interface$.instrument.token.factory.Factory", Factory.TEMPLATE_ID, ContractId::new, View.valueDecoder(),
