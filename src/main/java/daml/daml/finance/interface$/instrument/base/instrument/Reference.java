...
public final class Reference extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("0337d95cbc03800a2dea97d4d6edad768f08b69e119abf4729f77705965e0f58", "Daml.Finance.Interface.Instrument.Base.Instrument", "Reference");
  ...
  public static final ContractCompanion.WithKey<Contract, ContractId, Reference, InstrumentKey> COMPANION = 
      new ContractCompanion.WithKey<>(
        "daml.daml.finance.interface$.instrument.base.instrument.Reference", TEMPLATE_ID,
  ...
  public static Update<Created<ContractId>> create(View instrumentView, Instrument.ContractId cid,
      Map<String, Set<String>> observers) {
  ...
  public static JsonLfDecoder<Reference> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("instrumentView", "cid", "observers"), name -> {
          switch (name) {
            case "instrumentView": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(0, daml.daml.finance.interface$.instrument.base.instrument.View.jsonDecoder());
            case "cid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(1, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(daml.daml.finance.interface$.instrument.base.instrument.Instrument.ContractId::new));
  ...
  public JsonLfEncoder jsonEncoder() {
    return JsonLfEncoders.record(
        JsonLfEncoders.Field.of("instrumentView", apply(View::jsonEncoder, instrumentView)),
  ...
  public String toString() {
    return String.format("daml.daml.finance.interface$.instrument.base.instrument.Reference(%s, %s, %s)",
