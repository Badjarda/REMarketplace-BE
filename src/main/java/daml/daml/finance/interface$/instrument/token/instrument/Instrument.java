package daml.daml.finance.interface$.instrument.token.instrument;
...
public final class Instrument {
  public static final Identifier TEMPLATE_ID = new Identifier("ed0ddc9629bb602042cfa07ad9cab51df97016b81309db004c9d25ea8d6fbc9d", "Daml.Finance.Interface.Instrument.Token.Instrument", "Instrument");
  ...
  public static final class INTERFACE_ extends InterfaceCompanion<Instrument, ContractId, View> {
    INTERFACE_() {
      super(
            "daml.daml.finance.interface$.instrument.token.instrument.Instrument", Instrument.TEMPLATE_ID, ContractId::new, View.valueDecoder(),
