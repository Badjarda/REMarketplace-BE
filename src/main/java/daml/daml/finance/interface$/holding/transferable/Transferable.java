...
public final class Transferable {
  public static final Identifier TEMPLATE_ID = new Identifier("1b3dd202f2b5f6e97f0cc3426598a0c6c4725d8885e9e91d14377dce3e451348", "Daml.Finance.Interface.Holding.Transferable", "Transferable");
  ...
  public static final class INTERFACE_ extends InterfaceCompanion<Transferable, ContractId, View> {
    INTERFACE_() {
      super(
            "daml.daml.finance.interface$.holding.transferable.Transferable", Transferable.TEMPLATE_ID, ContractId::new, View.valueDecoder(),
            View::fromJson,List.of(CHOICE_Transfer, CHOICE_GetView, CHOICE_Archive));
    }
  }
}
