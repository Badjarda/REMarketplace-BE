...
public class View extends DamlRecord<View> {
  ...
  public static JsonLfDecoder<View> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("modifiers"), name -> {
          switch (name) {
            case "modifiers": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(0, daml.da.set.types.Set.jsonDecoder(com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.party));
            default: return null;
          }
        }
  ...
  public JsonLfEncoder jsonEncoder() {
    return JsonLfEncoders.record(
        JsonLfEncoders.Field.of("modifiers", apply(_x0 -> _x0.jsonEncoder(JsonLfEncoders::party), modifiers)));
  }
  ...
  public String toString() {
    return String.format("daml.daml.finance.interface$.holding.fungible.View(%s)", this.modifiers);
  }
}
