...
public final class Holding {
  public static final Identifier TEMPLATE_ID = new Identifier("1b3dd202f2b5f6e97f0cc3426598a0c6c4725d8885e9e91d14377dce3e451348", "Daml.Finance.Interface.Holding.Holding", "Holding");

  public static final Choice<Holding, GetView, View> CHOICE_GetView = 
      Choice.create("GetView", value$ -> value$.toValue(), value$ -> GetView.valueDecoder()
        .decode(value$), value$ -> View.valueDecoder().decode(value$));

  public static final Choice<Holding, daml.da.internal.template.Archive, Unit> CHOICE_Archive = 
  ...
  public static final class INTERFACE_ extends InterfaceCompanion<Holding, ContractId, View> {
    INTERFACE_() {
      super(
            "daml.daml.finance.interface$.holding.holding.Holding", Holding.TEMPLATE_ID, ContractId::new, View.valueDecoder(),
