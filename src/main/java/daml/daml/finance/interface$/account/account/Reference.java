...
public final class Reference extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("20095234ad30447a6c709382b0ff3ed4ed0cbaf588e1048499bcdfa78a9e774c", "Daml.Finance.Interface.Account.Account", "Reference");
  ...
  public static final ContractCompanion.WithKey<Contract, ContractId, Reference, AccountKey> COMPANION = 
      new ContractCompanion.WithKey<>("daml.daml.finance.interface$.account.account.Reference",
        ...
        CHOICE_Archive, CHOICE_GetCid), e -> AccountKey.valueDecoder().decode(e));
   ...
   */
  @Deprecated
  public static Update<Exercised<Unit>> exerciseByKeyArchive(AccountKey key,
  ...
  public static Update<Created<ContractId>> create(View accountView, Account.ContractId cid,
  ...
  public static JsonLfDecoder<Reference> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("accountView", "cid", "observers"), name -> {
          switch (name) {
            case "accountView": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(0, daml.daml.finance.interface$.account.account.View.jsonDecoder());
            case "cid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(1, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(daml.daml.finance.interface$.account.account.Account.ContractId::new));
  ...
  public JsonLfEncoder jsonEncoder() {
    return JsonLfEncoders.record(
        JsonLfEncoders.Field.of("accountView", apply(View::jsonEncoder, accountView)),
  ...
  public String toString() {
    return String.format("daml.daml.finance.interface$.account.account.Reference(%s, %s, %s)",
