...
public class Instruct extends DamlRecord<Instruct> {
  ...
  public Instruct(String instructor, Set<String> consenters, Set<String> settlers, Id id,
  ...
  public static ValueDecoder<Instruct> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new Instruct(instructor, consenters, settlers, id, description, contextId, routedSteps,
          settlementTime);
    } ;
  }
  ...
  public static JsonLfDecoder<Instruct> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("instructor", "consenters", "settlers", "id", "description", "contextId", "routedSteps", "settlementTime"), name -> {
        ...
        , (Object[] args) -> new Instruct(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3]), JsonLfDecoders.cast(args[4]), JsonLfDecoders.cast(args[5]), JsonLfDecoders.cast(args[6]), JsonLfDecoders.cast(args[7])));
  }

  public static Instruct fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public String toString() {
    return String.format("daml.daml.finance.interface$.settlement.factory.Instruct(%s, %s, %s, %s, %s, %s, %s, %s)",
