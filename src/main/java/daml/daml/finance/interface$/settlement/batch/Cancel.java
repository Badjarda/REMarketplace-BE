...
public class Cancel extends DamlRecord<Cancel> {
  ...
  public Cancel(Set<String> actors) {
    this.actors = actors;
  }
   ...
   */
  @Deprecated
  public static Cancel fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<Cancel> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
  ...
  public static JsonLfDecoder<Cancel> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("actors"), name -> {
        ...
        , (Object[] args) -> new Cancel(JsonLfDecoders.cast(args[0])));
  }

  public static Cancel fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public String toString() {
    return String.format("daml.daml.finance.interface$.settlement.batch.Cancel(%s)", this.actors);
  }
}
