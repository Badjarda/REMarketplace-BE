...
public class View extends DamlRecord<View> {
  ...
  public static JsonLfDecoder<View> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("providers", "id", "description", "eventTime"), name -> {
          switch (name) {
            ...
            case "eventTime": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(3, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.timestamp);
            default: return null;
          }
        }
  ...
  public JsonLfEncoder jsonEncoder() {
    return JsonLfEncoders.record(
        ...
        JsonLfEncoders.Field.of("eventTime", apply(JsonLfEncoders::timestamp, eventTime)));
  }
  ...
  public String toString() {
    return String.format("daml.daml.finance.interface$.lifecycle.event.View(%s, %s, %s, %s)",
