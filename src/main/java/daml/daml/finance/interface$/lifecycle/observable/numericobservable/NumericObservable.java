...
public final class NumericObservable {
  public static final Identifier TEMPLATE_ID = new Identifier("b915eb59058bda9951c2eb9ff1ef32c9a4042cc0d1604fb008d84dad7cab5e46", "Daml.Finance.Interface.Lifecycle.Observable.NumericObservable", "NumericObservable");
  ...
  public static final Choice<NumericObservable, daml.da.internal.template.Archive, Unit> CHOICE_Archive = 
  ...
  public static final class INTERFACE_ extends InterfaceCompanion<NumericObservable, ContractId, View> {
    INTERFACE_() {
      super(
            "daml.daml.finance.interface$.lifecycle.observable.numericobservable.NumericObservable", NumericObservable.TEMPLATE_ID, ContractId::new, View.valueDecoder(),
            View::fromJson,List.of(CHOICE_GetView, CHOICE_Archive, CHOICE_Observe));
    }
  }
}
