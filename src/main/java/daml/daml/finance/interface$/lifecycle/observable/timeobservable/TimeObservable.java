...
public final class TimeObservable {
  public static final Identifier TEMPLATE_ID = new Identifier("b915eb59058bda9951c2eb9ff1ef32c9a4042cc0d1604fb008d84dad7cab5e46", "Daml.Finance.Interface.Lifecycle.Observable.TimeObservable", "TimeObservable");
  ...
  public static final Choice<TimeObservable, daml.da.internal.template.Archive, Unit> CHOICE_Archive = 
  ...
  public static final class INTERFACE_ extends InterfaceCompanion<TimeObservable, ContractId, View> {
    INTERFACE_() {
      super(
            "daml.daml.finance.interface$.lifecycle.observable.timeobservable.TimeObservable", TimeObservable.TEMPLATE_ID, ContractId::new, View.valueDecoder(),
            View::fromJson,List.of(CHOICE_GetView, CHOICE_Archive, CHOICE_GetTime));
    }
  }
}
