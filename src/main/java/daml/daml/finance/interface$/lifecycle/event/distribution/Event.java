...
public final class Event {
  public static final Identifier TEMPLATE_ID = new Identifier("b915eb59058bda9951c2eb9ff1ef32c9a4042cc0d1604fb008d84dad7cab5e46", "Daml.Finance.Interface.Lifecycle.Event.Distribution", "Event");
  ...
  public static final class INTERFACE_ extends InterfaceCompanion<Event, ContractId, View> {
    INTERFACE_() {
      super(
            "daml.daml.finance.interface$.lifecycle.event.distribution.Event", Event.TEMPLATE_ID, ContractId::new, View.valueDecoder(),
