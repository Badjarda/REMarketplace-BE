package daml.daml.finance.interface$.lifecycle.event;
...
public final class Event {
  public static final Identifier TEMPLATE_ID = new Identifier("b915eb59058bda9951c2eb9ff1ef32c9a4042cc0d1604fb008d84dad7cab5e46", "Daml.Finance.Interface.Lifecycle.Event", "Event");

  public static final Choice<Event, GetView, View> CHOICE_GetView = 
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Event> implements Exercises<ExerciseCommand> {
    ...
    @Override
    protected ContractTypeCompanion<? extends Contract<ContractId, ?>, ContractId, Event, ?> getCompanion(
        ) {
      return INTERFACE;
    }
  }
  ...
  public static final class INTERFACE_ extends InterfaceCompanion<Event, ContractId, View> {
    INTERFACE_() {
      super(
            "daml.daml.finance.interface$.lifecycle.event.Event", Event.TEMPLATE_ID, ContractId::new, View.valueDecoder(),
            View::fromJson,List.of(CHOICE_GetView, CHOICE_Archive));
    }
  }
}
