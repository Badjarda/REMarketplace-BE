...
public final class Claim {
  public static final Identifier TEMPLATE_ID = new Identifier("b915eb59058bda9951c2eb9ff1ef32c9a4042cc0d1604fb008d84dad7cab5e46", "Daml.Finance.Interface.Lifecycle.Rule.Claim", "Claim");
  ...
  public static final Choice<Claim, daml.da.internal.template.Archive, Unit> CHOICE_Archive = 
  ...
  public interface Exercises<Cmd> extends com.daml.ledger.javaapi.data.codegen.Exercises.Archive<Cmd> {
    ...
    default Update<Exercised<ClaimResult>> exerciseClaimEffect(String claimer,
        List<Holding.ContractId> holdingCids, Effect.ContractId effectCid, Id batchId) {
  ...
  public static final class INTERFACE_ extends InterfaceCompanion<Claim, ContractId, View> {
    INTERFACE_() {
      super(
            "daml.daml.finance.interface$.lifecycle.rule.claim.Claim", Claim.TEMPLATE_ID, ContractId::new, View.valueDecoder(),
            View::fromJson,List.of(CHOICE_ClaimEffect, CHOICE_GetView, CHOICE_Archive));
    }
  }
}
