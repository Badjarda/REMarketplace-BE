...
public final class Factory extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("24a2deca43fad2e0010e2b864ed3f652a223165c72b9dbc29121eafe245793ad", "Daml.Finance.Account.Account", "Factory");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Factory> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.daml.finance.account.account.Factory", TEMPLATE_ID,
  ...
  public String toString() {
    return String.format("daml.daml.finance.account.account.Factory(%s, %s)", this.provider,
        this.observers);
  }
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Factory> implements Exercises<ExerciseCommand> {
    ...
    public daml.daml.finance.interface$.account.factory.Factory.ContractId toInterface(
        daml.daml.finance.interface$.account.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new daml.daml.finance.interface$.account.factory.Factory.ContractId(this.contractId);
    }
    ...
    public static ContractId unsafeFromInterface(
        daml.daml.finance.interface$.account.factory.Factory.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.daml.finance.interface$.account.factory.Factory.CreateAnd toInterface(
        daml.daml.finance.interface$.account.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new daml.daml.finance.interface$.account.factory.Factory.CreateAnd(COMPANION, this.createArguments);
    }
