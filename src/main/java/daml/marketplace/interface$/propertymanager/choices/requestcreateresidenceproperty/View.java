...
public class View extends DamlRecord<View> {
  ...
  public static ValueDecoder<View> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new View(operator, user, id, residenceInstrument, residencePrice, propertyAddress,
  ...
  public String toString() {
    return String.format("daml.interface$.propertymanager.choices.requestcreateresidenceproperty.View(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
