package daml.marketplace.interface$.propertymanager.choices.requestcreateresidenceproperty;
...
public class View extends DamlRecord<View> {
  ...
  public View(String operator, String user, Id id, InstrumentKey residenceInstrument,
  ...
  public static ValueDecoder<View> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new View(operator, user, id, residenceInstrument, propertyAddress, propertyPostalCode,
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.propertymanager.choices.requestcreateresidenceproperty.View(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
