...
public class View extends DamlRecord<View> {
  ...
  public static ValueDecoder<View> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new View(operator, user, id, apartmentInstrument, propertyAddress, propertyPostalCode,
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.propertymanager.choices.requestcreateapartmentproperty.View(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
