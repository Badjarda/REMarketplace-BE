...
public class UpdateResidence extends DamlRecord<UpdateResidence> {
  ...
  public static JsonLfDecoder<UpdateResidence> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("newResidencePrice", "newResidencePropertyAddress", "newResidencePropertyPostalCode", "newResidencePropertyDistrict", "newResidencePropertyCounty", "newResidenceGrossArea", "newResidenceUsableArea", "newResidenceBedrooms", "newResidenceBathrooms", "newResidenceFloors", "newResidenceType", "newResidenceBackyard", "newResidenceParking", "newResidenceBuildDate", "newResidenceOrientation", "newResidenceInstalledEquipment", "newResidenceAdditionalInformation", "newResidenceDescription", "newResidencePhotoReferences", "propertyKey"), name -> {
          switch (name) {
            ...
            case "newResidenceType": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(10, daml.marketplace.interface$.propertymanager.property.common.ResidenceType.jsonDecoder());
            ...
            case "newResidenceParking": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(12, daml.marketplace.interface$.propertymanager.property.common.Parking.jsonDecoder());
            ...
            case "newResidenceOrientation": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(14, daml.marketplace.interface$.propertymanager.property.common.Orientation.jsonDecoder());
            ...
            case "propertyKey": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(19, daml.marketplace.interface$.common.types.PropertyKey.jsonDecoder());
            default: return null;
          }
        }
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.propertymanager.service.UpdateResidence(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
