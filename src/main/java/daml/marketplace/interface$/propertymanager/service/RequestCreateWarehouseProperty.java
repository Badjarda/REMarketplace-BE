...
public class RequestCreateWarehouseProperty extends DamlRecord<RequestCreateWarehouseProperty> {
  ...
  public RequestCreateWarehouseProperty(Id id, InstrumentKey warehouseInstrument,
  ...
  public static ValueDecoder<RequestCreateWarehouseProperty> valueDecoder() throws
    ...
    return value$ -> {
      ...
      WarehouseType warehouseType = WarehouseType.valueDecoder().decode(fields$.get(6).getValue());
      ...
      Long floors = PrimitiveValueDecoders.fromInt64.decode(fields$.get(9).getValue());
      LocalDate buildDate = PrimitiveValueDecoders.fromDate.decode(fields$.get(10).getValue());
      ...
      return new RequestCreateWarehouseProperty(id, warehouseInstrument, propertyAddress,
  ...
  public static JsonLfDecoder<RequestCreateWarehouseProperty> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("id", "warehouseInstrument", "propertyAddress", "propertyPostalCode", "propertyDistrict", "propertyCounty", "warehouseType", "grossArea", "usableArea", "floors", "buildDate", "installedEquipment", "additionalInformation", "description", "observers"), name -> {
          switch (name) {
            ...
            case "warehouseInstrument": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(1, daml.daml.finance.interface$.types.common.types.InstrumentKey.jsonDecoder());
            ...
            case "warehouseType": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(6, daml.marketplace.interface$.propertymanager.property.common.WarehouseType.jsonDecoder());
            ...
            case "floors": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(9, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.int64);
            case "buildDate": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(10, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.date);
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.id, this.warehouseInstrument, this.propertyAddress,
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.propertymanager.service.RequestCreateWarehouseProperty(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        this.id, this.warehouseInstrument, this.propertyAddress, this.propertyPostalCode,
        this.propertyDistrict, this.propertyCounty, this.warehouseType, this.grossArea,
        this.usableArea, this.floors, this.buildDate, this.installedEquipment,
        this.additionalInformation, this.description, this.observers);
  }
}
