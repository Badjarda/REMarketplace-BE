...
public class RequestCreateApartmentProperty extends DamlRecord<RequestCreateApartmentProperty> {
  ...
  public static ValueDecoder<RequestCreateApartmentProperty> valueDecoder() throws
    ...
    return value$ -> {
      ...
      return new RequestCreateApartmentProperty(id, apartmentInstrument, apartmentPrice,
          propertyAddress, propertyPostalCode, propertyDistrict, propertyCounty, grossArea,
          usableArea, bedrooms, bathrooms, floor, parkingSpaces, elevator, buildDate,
  ...
  public static JsonLfDecoder<RequestCreateApartmentProperty> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("id", "apartmentInstrument", "apartmentPrice", "propertyAddress", "propertyPostalCode", "propertyDistrict", "propertyCounty", "grossArea", "usableArea", "bedrooms", "bathrooms", "floor", "parkingSpaces", "elevator", "buildDate", "installedEquipment", "additionalInformation", "description", "observers"), name -> {
          switch (name) {
            ...
            case "apartmentPrice": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(2, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.numeric(10));
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.id, this.apartmentInstrument, this.apartmentPrice,
  ...
  public String toString() {
    return String.format("daml.interface$.propertymanager.service.RequestCreateApartmentProperty(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        this.id, this.apartmentInstrument, this.apartmentPrice, this.propertyAddress,
