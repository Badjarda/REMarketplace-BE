...
public class RequestCreateApartmentProperty extends DamlRecord<RequestCreateApartmentProperty> {
  ...
  public RequestCreateApartmentProperty(Id id, InstrumentKey apartmentInstrument,
  ...
  public static ValueDecoder<RequestCreateApartmentProperty> valueDecoder() throws
    ...
    return value$ -> {
      ...
      Long floor = PrimitiveValueDecoders.fromInt64.decode(fields$.get(10).getValue());
      Long parkingSpaces = PrimitiveValueDecoders.fromInt64.decode(fields$.get(11).getValue());
      Boolean elevator = PrimitiveValueDecoders.fromBool.decode(fields$.get(12).getValue());
      ...
      return new RequestCreateApartmentProperty(id, apartmentInstrument, propertyAddress,
  ...
  public static JsonLfDecoder<RequestCreateApartmentProperty> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("id", "apartmentInstrument", "propertyAddress", "propertyPostalCode", "propertyDistrict", "propertyCounty", "grossArea", "usableArea", "bedrooms", "bathrooms", "floor", "parkingSpaces", "elevator", "buildDate", "installedEquipment", "additionalInformation", "description", "observers"), name -> {
          switch (name) {
            ...
            case "apartmentInstrument": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(1, daml.daml.finance.interface$.types.common.types.InstrumentKey.jsonDecoder());
            ...
            case "floor": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(10, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.int64);
            case "parkingSpaces": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(11, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.int64);
            case "elevator": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(12, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.bool);
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.id, this.apartmentInstrument, this.propertyAddress,
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.propertymanager.service.RequestCreateApartmentProperty(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        this.id, this.apartmentInstrument, this.propertyAddress, this.propertyPostalCode,
        this.propertyDistrict, this.propertyCounty, this.grossArea, this.usableArea, this.bedrooms,
        this.bathrooms, this.floor, this.parkingSpaces, this.elevator, this.buildDate,
