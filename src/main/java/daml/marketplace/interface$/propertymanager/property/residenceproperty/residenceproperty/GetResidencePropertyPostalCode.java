...
public class GetResidencePropertyPostalCode extends DamlRecord<GetResidencePropertyPostalCode> {
  public static final String _packageId = "8c6e592f5a33911df4c5cbfd683c840613ba80718b2d85f183257ac23495fc1f";

  public GetResidencePropertyPostalCode() {
  }
   ...
   */
  @Deprecated
  public static GetResidencePropertyPostalCode fromValue(Value value$) throws
      IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<GetResidencePropertyPostalCode> valueDecoder() throws
      IllegalArgumentException {
    return value$ -> {
      Value recordValue$ = value$;
      List<com.daml.ledger.javaapi.data.DamlRecord.Field> fields$ = PrimitiveValueDecoders.recordCheck(0,0,
          recordValue$);
      return new GetResidencePropertyPostalCode();
    } ;
  }
  ...
  public static JsonLfDecoder<GetResidencePropertyPostalCode> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new GetResidencePropertyPostalCode());
  }

  public static GetResidencePropertyPostalCode fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof GetResidencePropertyPostalCode)) {
      return false;
    }
    return true;
  }
