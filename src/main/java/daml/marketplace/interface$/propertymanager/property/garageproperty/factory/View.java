...
public class View extends DamlRecord<View> {
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.propertymanager.property.garageproperty.factory.View(%s)",
        this.operator);
  }
}
