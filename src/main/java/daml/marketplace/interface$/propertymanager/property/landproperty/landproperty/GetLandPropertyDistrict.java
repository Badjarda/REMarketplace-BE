...
public class GetLandPropertyDistrict extends DamlRecord<GetLandPropertyDistrict> {
  public static final String _packageId = "ab9bbdb36a2cfacb7b3bd66e0d472fb99ff4b9d98bdf81e76a5b8bd3b57250a9";

  public GetLandPropertyDistrict() {
  }
   ...
   */
  @Deprecated
  public static GetLandPropertyDistrict fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<GetLandPropertyDistrict> valueDecoder() throws
      IllegalArgumentException {
    return value$ -> {
      Value recordValue$ = value$;
      List<com.daml.ledger.javaapi.data.DamlRecord.Field> fields$ = PrimitiveValueDecoders.recordCheck(0,0,
          recordValue$);
      return new GetLandPropertyDistrict();
    } ;
  }
  ...
  public static JsonLfDecoder<GetLandPropertyDistrict> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new GetLandPropertyDistrict());
  }

  public static GetLandPropertyDistrict fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof GetLandPropertyDistrict)) {
      return false;
    }
    return true;
  }
