...
public class GetApartmentGrossArea extends DamlRecord<GetApartmentGrossArea> {
  public static final String _packageId = "7410dc0c147f7a1f02e29af653f3db7c67fc88031d45c6c69171d322a8445411";

  public GetApartmentGrossArea() {
  }
   ...
   */
  @Deprecated
  public static GetApartmentGrossArea fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<GetApartmentGrossArea> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      Value recordValue$ = value$;
      List<com.daml.ledger.javaapi.data.DamlRecord.Field> fields$ = PrimitiveValueDecoders.recordCheck(0,0,
          recordValue$);
      return new GetApartmentGrossArea();
    } ;
  }
  ...
  public static JsonLfDecoder<GetApartmentGrossArea> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new GetApartmentGrossArea());
  }

  public static GetApartmentGrossArea fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof GetApartmentGrossArea)) {
      return false;
    }
    return true;
  }
