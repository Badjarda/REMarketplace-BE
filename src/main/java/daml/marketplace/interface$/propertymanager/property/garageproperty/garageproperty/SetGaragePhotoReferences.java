...
public class SetGaragePhotoReferences extends DamlRecord<SetGaragePhotoReferences> {
  public static final String _packageId = "f8883c36e16696951f0e9312ee45dacca92b05226daf215a5159b95d1b1c4079";

  public final List<String> newPhotoReferences;

  public SetGaragePhotoReferences(List<String> newPhotoReferences) {
   ...
   */
  @Deprecated
  public static SetGaragePhotoReferences fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<SetGaragePhotoReferences> valueDecoder() throws
    ...
    return value$ -> {
      ...
      return new SetGaragePhotoReferences(newPhotoReferences);
    } ;
  }
  ...
  public static JsonLfDecoder<SetGaragePhotoReferences> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("newPhotoReferences"), name -> {
        ...
        , (Object[] args) -> new SetGaragePhotoReferences(JsonLfDecoders.cast(args[0])));
  }

  public static SetGaragePhotoReferences fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof SetGaragePhotoReferences)) {
      return false;
    }
    SetGaragePhotoReferences other = (SetGaragePhotoReferences) object;
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.propertymanager.property.garageproperty.garageproperty.SetGaragePhotoReferences(%s)",
