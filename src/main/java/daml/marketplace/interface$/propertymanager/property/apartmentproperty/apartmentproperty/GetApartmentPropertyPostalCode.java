...
public class GetApartmentPropertyPostalCode extends DamlRecord<GetApartmentPropertyPostalCode> {
   ...
   */
  @Deprecated
  public static GetApartmentPropertyPostalCode fromValue(Value value$) throws
      IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<GetApartmentPropertyPostalCode> valueDecoder() throws
      IllegalArgumentException {
    return value$ -> {
      Value recordValue$ = value$;
      List<com.daml.ledger.javaapi.data.DamlRecord.Field> fields$ = PrimitiveValueDecoders.recordCheck(0,0,
          recordValue$);
      return new GetApartmentPropertyPostalCode();
    } ;
  }
  ...
  public static JsonLfDecoder<GetApartmentPropertyPostalCode> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new GetApartmentPropertyPostalCode());
  }

  public static GetApartmentPropertyPostalCode fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof GetApartmentPropertyPostalCode)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    return "daml.marketplace.interface$.propertymanager.property.apartmentproperty.apartmentproperty.GetApartmentPropertyPostalCode";
  }
}
