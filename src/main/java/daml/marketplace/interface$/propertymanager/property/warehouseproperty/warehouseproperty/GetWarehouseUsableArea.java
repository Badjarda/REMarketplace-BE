...
public class GetWarehouseUsableArea extends DamlRecord<GetWarehouseUsableArea> {
  public static final String _packageId = "e09e7a18c217e8002e4a374c04915d394e5120e173ac8f1ee6decbc2d8c3c8b4";

  public GetWarehouseUsableArea() {
  }
   ...
   */
  @Deprecated
  public static GetWarehouseUsableArea fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<GetWarehouseUsableArea> valueDecoder() throws
      IllegalArgumentException {
    return value$ -> {
      Value recordValue$ = value$;
      List<com.daml.ledger.javaapi.data.DamlRecord.Field> fields$ = PrimitiveValueDecoders.recordCheck(0,0,
          recordValue$);
      return new GetWarehouseUsableArea();
    } ;
  }
  ...
  public static JsonLfDecoder<GetWarehouseUsableArea> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new GetWarehouseUsableArea());
  }

  public static GetWarehouseUsableArea fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof GetWarehouseUsableArea)) {
      return false;
    }
    return true;
  }
