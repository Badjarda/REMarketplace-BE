...
public class SetWarehousePhotoReferences extends DamlRecord<SetWarehousePhotoReferences> {
  public static final String _packageId = "f8883c36e16696951f0e9312ee45dacca92b05226daf215a5159b95d1b1c4079";

  public final List<String> newPhotoReferences;

  public SetWarehousePhotoReferences(List<String> newPhotoReferences) {
   ...
   */
  @Deprecated
  public static SetWarehousePhotoReferences fromValue(Value value$) throws
      IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<SetWarehousePhotoReferences> valueDecoder() throws
      IllegalArgumentException {
    return value$ -> {
      ...
      return new SetWarehousePhotoReferences(newPhotoReferences);
    } ;
  }
  ...
  public static JsonLfDecoder<SetWarehousePhotoReferences> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("newPhotoReferences"), name -> {
        ...
        , (Object[] args) -> new SetWarehousePhotoReferences(JsonLfDecoders.cast(args[0])));
  }

  public static SetWarehousePhotoReferences fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof SetWarehousePhotoReferences)) {
      return false;
    }
    SetWarehousePhotoReferences other = (SetWarehousePhotoReferences) object;
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.propertymanager.property.warehouseproperty.warehouseproperty.SetWarehousePhotoReferences(%s)",
