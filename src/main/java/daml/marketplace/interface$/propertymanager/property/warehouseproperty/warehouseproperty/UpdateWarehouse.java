...
public class UpdateWarehouse extends DamlRecord<UpdateWarehouse> {
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.propertymanager.property.warehouseproperty.warehouseproperty.UpdateWarehouse(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
