...
public class Create extends DamlRecord<Create> {
  ...
  public Create(InstrumentKey instrument, BigDecimal residencePrice, PropertyKey propertyKey,
  ...
  public static ValueDecoder<Create> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new Create(instrument, residencePrice, propertyKey, propertyAddress,
  ...
  public static JsonLfDecoder<Create> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("instrument", "residencePrice", "propertyKey", "propertyAddress", "propertyPostalCode", "propertyDistrict", "propertyCounty", "grossArea", "usableArea", "bedrooms", "bathrooms", "floors", "residenceType", "backyard", "parking", "buildDate", "orientation", "installedEquipment", "additionalInformation", "description", "photoReferences", "observers"), name -> {
          switch (name) {
            ...
            case "residencePrice": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(1, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.numeric(10));
            case "propertyKey": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(2, daml.marketplace.interface$.common.types.PropertyKey.jsonDecoder());
            ...
            case "residenceType": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(12, daml.marketplace.interface$.propertymanager.property.common.ResidenceType.jsonDecoder());
            ...
            case "parking": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(14, daml.marketplace.interface$.propertymanager.property.common.Parking.jsonDecoder());
            ...
            case "orientation": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(16, daml.marketplace.interface$.propertymanager.property.common.Orientation.jsonDecoder());
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.instrument, this.residencePrice, this.propertyKey,
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.propertymanager.property.residenceproperty.factory.Create(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        this.instrument, this.residencePrice, this.propertyKey, this.propertyAddress,
