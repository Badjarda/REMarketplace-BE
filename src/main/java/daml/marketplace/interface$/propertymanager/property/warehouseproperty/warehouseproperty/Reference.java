...
public final class Reference extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("8b6e58552ef878dbcd4586daf541e0ca6dd1b0d75795e7f9ece68259cb3242b1", "Interface.PropertyManager.Property.WarehouseProperty.WarehouseProperty", "Reference");
  ...
  public static final Choice<Reference, GetCid, WarehouseProperty.ContractId> CHOICE_GetCid = 
  ...
  public static final ContractCompanion.WithKey<Contract, ContractId, Reference, PropertyKey> COMPANION = 
      new ContractCompanion.WithKey<>(
        "daml.marketplace.interface$.propertymanager.property.warehouseproperty.warehouseproperty.Reference",
  ...
  public final View warehousePropertyView;

  public final WarehouseProperty.ContractId cid;

  public final Map<String, Set<String>> observers;

  public Reference(View warehousePropertyView, WarehouseProperty.ContractId cid,
      Map<String, Set<String>> observers) {
    this.warehousePropertyView = warehousePropertyView;
    this.cid = cid;
  ...
  public static Update<Exercised<ContractId>> exerciseByKeySetCid(PropertyKey key,
      WarehouseProperty.ContractId newCid) {
   ...
   */
  @Deprecated
  public static Update<Exercised<WarehouseProperty.ContractId>> exerciseByKeyGetCid(PropertyKey key,
      GetCid arg) {
   ...
   */
  @Deprecated
  public Update<Exercised<WarehouseProperty.ContractId>> createAndExerciseGetCid(GetCid arg) {
   ...
   */
  @Deprecated
  public Update<Exercised<WarehouseProperty.ContractId>> createAndExerciseGetCid(String viewer) {
    return createAndExerciseGetCid(new GetCid(viewer));
  }

  public static Update<Created<ContractId>> create(View warehousePropertyView,
      WarehouseProperty.ContractId cid, Map<String, Set<String>> observers) {
    return new Reference(warehousePropertyView, cid, observers).create();
  }
  ...
  public DamlRecord toValue() {
    ...
    fields.add(new DamlRecord.Field("warehousePropertyView", this.warehousePropertyView.toValue()));
  ...
  private static ValueDecoder<Reference> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      View warehousePropertyView = View.valueDecoder().decode(fields$.get(0).getValue());
      WarehouseProperty.ContractId cid =
          new WarehouseProperty.ContractId(fields$.get(1).getValue().asContractId().orElseThrow(() -> new IllegalArgumentException("Expected cid to be of type com.daml.ledger.javaapi.data.ContractId")).getValue());
      Map<String, Set<String>> observers = PrimitiveValueDecoders.fromGenMap(
            PrimitiveValueDecoders.fromText,
            Set.<java.lang.String>valueDecoder(PrimitiveValueDecoders.fromParty))
          .decode(fields$.get(2).getValue());
      return new Reference(warehousePropertyView, cid, observers);
    } ;
  }

  public static JsonLfDecoder<Reference> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("warehousePropertyView", "cid", "observers"), name -> {
          switch (name) {
            case "warehousePropertyView": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(0, daml.marketplace.interface$.propertymanager.property.warehouseproperty.warehouseproperty.View.jsonDecoder());
            case "cid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(1, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(daml.marketplace.interface$.propertymanager.property.warehouseproperty.warehouseproperty.WarehouseProperty.ContractId::new));
  ...
  public JsonLfEncoder jsonEncoder() {
    return JsonLfEncoders.record(
        JsonLfEncoders.Field.of("warehousePropertyView", apply(View::jsonEncoder, warehousePropertyView)),
  ...
  public boolean equals(Object object) {
    ...
    return Objects.equals(this.warehousePropertyView, other.warehousePropertyView) &&
        Objects.equals(this.cid, other.cid) && Objects.equals(this.observers, other.observers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.warehousePropertyView, this.cid, this.observers);
  }

  @Override
  public String toString() {
    return String.format("daml.marketplace.interface$.propertymanager.property.warehouseproperty.warehouseproperty.Reference(%s, %s, %s)",
        this.warehousePropertyView, this.cid, this.observers);
  }
  ...
  public interface Exercises<Cmd> extends com.daml.ledger.javaapi.data.codegen.Exercises.Archive<Cmd> {
    ...
    default Update<Exercised<ContractId>> exerciseSetCid(WarehouseProperty.ContractId newCid) {
    ...
    default Update<Exercised<WarehouseProperty.ContractId>> exerciseGetCid(GetCid arg) {
      return makeExerciseCmd(CHOICE_GetCid, arg);
    }

    default Update<Exercised<WarehouseProperty.ContractId>> exerciseGetCid(String viewer) {
