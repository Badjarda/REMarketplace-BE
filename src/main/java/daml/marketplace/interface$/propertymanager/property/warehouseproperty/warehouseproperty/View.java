...
public class View extends DamlRecord<View> {
  ...
  public static JsonLfDecoder<View> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("operator", "user", "id", "instrument", "warehousePrice", "propertyAddress", "propertyPostalCode", "propertyDistrict", "propertyCounty", "warehouseType", "grossArea", "usableArea", "floors", "buildDate", "installedEquipment", "additionalInformation", "description"), name -> {
          switch (name) {
  ...
  public String toString() {
    return String.format("daml.interface$.propertymanager.property.warehouseproperty.warehouseproperty.View(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
