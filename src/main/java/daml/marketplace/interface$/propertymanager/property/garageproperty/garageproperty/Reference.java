...
public final class Reference extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("ab9bbdb36a2cfacb7b3bd66e0d472fb99ff4b9d98bdf81e76a5b8bd3b57250a9", "Interface.PropertyManager.Property.GarageProperty.GarageProperty", "Reference");
  ...
  public static final Choice<Reference, GetCid, GarageProperty.ContractId> CHOICE_GetCid = 
      Choice.create("GetCid", value$ -> value$.toValue(), value$ -> GetCid.valueDecoder()
        .decode(value$), value$ ->
        new GarageProperty.ContractId(value$.asContractId().orElseThrow(() -> new IllegalArgumentException("Expected value$ to be of type com.daml.ledger.javaapi.data.ContractId")).getValue()));
  ...
  public final View garagePropertyView;

  public final GarageProperty.ContractId cid;

  public final Map<String, Set<String>> observers;

  public Reference(View garagePropertyView, GarageProperty.ContractId cid,
      Map<String, Set<String>> observers) {
    this.garagePropertyView = garagePropertyView;
    this.cid = cid;
   ...
   */
  @Deprecated
  public static Update<Exercised<GarageProperty.ContractId>> exerciseByKeyGetCid(PropertyKey key,
      GetCid arg) {
   ...
   */
  @Deprecated
  public Update<Exercised<ContractId>> createAndExerciseSetCid(GarageProperty.ContractId newCid) {
   ...
   */
  @Deprecated
  public Update<Exercised<GarageProperty.ContractId>> createAndExerciseGetCid(GetCid arg) {
   ...
   */
  @Deprecated
  public Update<Exercised<GarageProperty.ContractId>> createAndExerciseGetCid(String viewer) {
    return createAndExerciseGetCid(new GetCid(viewer));
  }

  public static Update<Created<ContractId>> create(View garagePropertyView,
      GarageProperty.ContractId cid, Map<String, Set<String>> observers) {
    return new Reference(garagePropertyView, cid, observers).create();
  }
  ...
  public DamlRecord toValue() {
    ...
    fields.add(new DamlRecord.Field("garagePropertyView", this.garagePropertyView.toValue()));
  ...
  private static ValueDecoder<Reference> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      View garagePropertyView = View.valueDecoder().decode(fields$.get(0).getValue());
      GarageProperty.ContractId cid =
          new GarageProperty.ContractId(fields$.get(1).getValue().asContractId().orElseThrow(() -> new IllegalArgumentException("Expected cid to be of type com.daml.ledger.javaapi.data.ContractId")).getValue());
      Map<String, Set<String>> observers = PrimitiveValueDecoders.fromGenMap(
            PrimitiveValueDecoders.fromText,
            Set.<java.lang.String>valueDecoder(PrimitiveValueDecoders.fromParty))
          .decode(fields$.get(2).getValue());
      return new Reference(garagePropertyView, cid, observers);
    } ;
  }
  ...
  public JsonLfEncoder jsonEncoder() {
    return JsonLfEncoders.record(
        JsonLfEncoders.Field.of("garagePropertyView", apply(View::jsonEncoder, garagePropertyView)),
  ...
  public boolean equals(Object object) {
    ...
    return Objects.equals(this.garagePropertyView, other.garagePropertyView) &&
        Objects.equals(this.cid, other.cid) && Objects.equals(this.observers, other.observers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.garagePropertyView, this.cid, this.observers);
  }
  ...
  public interface Exercises<Cmd> extends com.daml.ledger.javaapi.data.codegen.Exercises.Archive<Cmd> {
    ...
    default Update<Exercised<ContractId>> exerciseSetCid(GarageProperty.ContractId newCid) {
    ...
    default Update<Exercised<GarageProperty.ContractId>> exerciseGetCid(GetCid arg) {
      return makeExerciseCmd(CHOICE_GetCid, arg);
    }

    default Update<Exercised<GarageProperty.ContractId>> exerciseGetCid(String viewer) {
