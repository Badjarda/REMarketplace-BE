...
public final class RequestCreateUserProfile {
  public static final Identifier TEMPLATE_ID = new Identifier("e09e7a18c217e8002e4a374c04915d394e5120e173ac8f1ee6decbc2d8c3c8b4", "Interface.ProfileManager.Choices.RequestCreateUserProfile", "RequestCreateUserProfile");
  ...
  private RequestCreateUserProfile() {
  }
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<RequestCreateUserProfile> implements Exercises<ExerciseCommand> {
    ...
    @Override
    protected ContractTypeCompanion<? extends Contract<ContractId, ?>, ContractId, RequestCreateUserProfile, ?> getCompanion(
        ) {
      return INTERFACE;
    }
  }
