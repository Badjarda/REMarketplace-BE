...
public class View extends DamlRecord<View> {
  ...
  public static ValueDecoder<View> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new View(operator, user, id, username, firstName, lastName, fullName, birthday, gender,
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.profilemanager.choices.requestcreateuserprofile.View(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
