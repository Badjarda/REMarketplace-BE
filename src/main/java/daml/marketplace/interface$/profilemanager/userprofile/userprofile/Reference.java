...
public final class Reference extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("8b6e58552ef878dbcd4586daf541e0ca6dd1b0d75795e7f9ece68259cb3242b1", "Interface.ProfileManager.UserProfile.UserProfile", "Reference");
  ...
  public static final Choice<Reference, GetCid, UserProfile.ContractId> CHOICE_GetCid = 
  ...
  public final UserProfile.ContractId cid;

  public final Map<String, Set<String>> observers;

  public Reference(View userProfileView, UserProfile.ContractId cid,
   ...
   */
  @Deprecated
  public static Update<Exercised<ContractId>> exerciseByKeySetCid(UserProfileKey key, SetCid arg) {
   ...
   */
  @Deprecated
  public static Update<Exercised<ContractId>> exerciseByKeySetCid(UserProfileKey key,
   ...
   */
  @Deprecated
  public static Update<Exercised<ContractId>> exerciseByKeySetObservers(UserProfileKey key,
      SetObservers arg) {
   ...
   */
  @Deprecated
  public static Update<Exercised<Unit>> exerciseByKeyArchive(UserProfileKey key,
   ...
   */
  @Deprecated
  public static Update<Exercised<UserProfile.ContractId>> exerciseByKeyGetCid(UserProfileKey key,
      GetCid arg) {
   ...
   */
  @Deprecated
  public Update<Exercised<ContractId>> createAndExerciseSetCid(UserProfile.ContractId newCid) {
   ...
   */
  @Deprecated
  public Update<Exercised<UserProfile.ContractId>> createAndExerciseGetCid(GetCid arg) {
   ...
   */
  @Deprecated
  public Update<Exercised<UserProfile.ContractId>> createAndExerciseGetCid(String viewer) {
    return createAndExerciseGetCid(new GetCid(viewer));
  }

  public static Update<Created<ContractId>> create(View userProfileView, UserProfile.ContractId cid,
      Map<String, Set<String>> observers) {
    return new Reference(userProfileView, cid, observers).create();
  }
  ...
  @Override
  protected ContractCompanion.WithKey<Contract, ContractId, Reference, UserProfileKey> getCompanion(
      ) {
    return COMPANION;
  }
  ...
  public DamlRecord toValue() {
    ...
    fields.add(new DamlRecord.Field("userProfileView", this.userProfileView.toValue()));
  ...
  private static ValueDecoder<Reference> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      View userProfileView = View.valueDecoder().decode(fields$.get(0).getValue());
      UserProfile.ContractId cid =
          new UserProfile.ContractId(fields$.get(1).getValue().asContractId().orElseThrow(() -> new IllegalArgumentException("Expected cid to be of type com.daml.ledger.javaapi.data.ContractId")).getValue());
      Map<String, Set<String>> observers = PrimitiveValueDecoders.fromGenMap(
            PrimitiveValueDecoders.fromText,
            Set.<java.lang.String>valueDecoder(PrimitiveValueDecoders.fromParty))
          .decode(fields$.get(2).getValue());
      return new Reference(userProfileView, cid, observers);
    } ;
  }
  ...
  public JsonLfEncoder jsonEncoder() {
    return JsonLfEncoders.record(
        JsonLfEncoders.Field.of("userProfileView", apply(View::jsonEncoder, userProfileView)),
  ...
  public boolean equals(Object object) {
    ...
    return Objects.equals(this.userProfileView, other.userProfileView) &&
        Objects.equals(this.cid, other.cid) && Objects.equals(this.observers, other.observers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.userProfileView, this.cid, this.observers);
  }
   ...
   */
  public static ByKey byKey(UserProfileKey key) {
  ...
  public static class Contract extends ContractWithKey<ContractId, Reference, UserProfileKey> {
    public Contract(ContractId id, Reference data, Optional<String> agreementText,
        Optional<UserProfileKey> key, java.util.Set<String> signatories,
    ...
    public static Contract fromIdAndRecord(String contractId, DamlRecord record$,
        Optional<String> agreementText, Optional<UserProfileKey> key,
  ...
  public interface Exercises<Cmd> extends com.daml.ledger.javaapi.data.codegen.Exercises.Archive<Cmd> {
    ...
    default Update<Exercised<ContractId>> exerciseSetCid(UserProfile.ContractId newCid) {
    ...
    default Update<Exercised<UserProfile.ContractId>> exerciseGetCid(GetCid arg) {
      return makeExerciseCmd(CHOICE_GetCid, arg);
    }

    default Update<Exercised<UserProfile.ContractId>> exerciseGetCid(String viewer) {
