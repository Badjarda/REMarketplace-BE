...
public class View extends DamlRecord<View> {
  ...
  public static ValueDecoder<View> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new View(operator, user, id, username, firstName, lastName, fullName, birthday, gender,
          nationality, contactMail, cellphoneNumber, taxId, socialSecurityId);
    } ;
  }
  ...
  public static JsonLfDecoder<View> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("operator", "user", "id", "username", "firstName", "lastName", "fullName", "birthday", "gender", "nationality", "contactMail", "cellphoneNumber", "taxId", "socialSecurityId"), name -> {
          switch (name) {
  ...
  public int hashCode() {
    return Objects.hash(this.operator, this.user, this.id, this.username, this.firstName,
        ...
        this.contactMail, this.cellphoneNumber, this.taxId, this.socialSecurityId);
  }

  @Override
  public String toString() {
    return String.format("daml.marketplace.interface$.profilemanager.userprofile.userprofile.View(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        this.cellphoneNumber, this.taxId, this.socialSecurityId);
  }
}
