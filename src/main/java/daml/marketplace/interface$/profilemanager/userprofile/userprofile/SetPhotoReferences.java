...
public class SetPhotoReferences extends DamlRecord<SetPhotoReferences> {
  ...
  public SetPhotoReferences(List<String> newPhotoReferences) {
   ...
   */
  @Deprecated
  public static SetPhotoReferences fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<SetPhotoReferences> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new SetPhotoReferences(newPhotoReferences);
    } ;
  }
  ...
  public static JsonLfDecoder<SetPhotoReferences> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("newPhotoReferences"), name -> {
        ...
        , (Object[] args) -> new SetPhotoReferences(JsonLfDecoders.cast(args[0])));
  }

  public static SetPhotoReferences fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof SetPhotoReferences)) {
      return false;
    }
    SetPhotoReferences other = (SetPhotoReferences) object;
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.profilemanager.userprofile.userprofile.SetPhotoReferences(%s)",
