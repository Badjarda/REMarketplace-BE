...
public class UpdateProfile extends DamlRecord<UpdateProfile> {
  ...
  public static ValueDecoder<UpdateProfile> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new UpdateProfile(newUsername, newFirstName, newLastName, newFullName, newPassword,
          ...
          newTaxId, newSocialSecurityId, newPhotoReferences, userProfileKey);
    } ;
  }
  ...
  public static JsonLfDecoder<UpdateProfile> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("newUsername", "newFirstName", "newLastName", "newFullName", "newPassword", "newBirthday", "newGender", "newNationality", "newContactMail", "newCellphoneNumber", "newIdNumber", "newTaxId", "newSocialSecurityId", "newPhotoReferences", "userProfileKey"), name -> {
          switch (name) {
            ...
            case "newGender": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(6, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.optional(daml.marketplace.interface$.profilemanager.userprofile.common.Gender.jsonDecoder()));
            case "newNationality": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(7, daml.marketplace.interface$.profilemanager.userprofile.common.Nationality.jsonDecoder());
            ...
            case "userProfileKey": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(14, daml.marketplace.interface$.common.types.UserProfileKey.jsonDecoder());
            default: return null;
          }
        }
  ...
  public int hashCode() {
    return Objects.hash(this.newUsername, this.newFirstName, this.newLastName, this.newFullName,
        ...
        this.newSocialSecurityId, this.newPhotoReferences, this.userProfileKey);
  }

  @Override
  public String toString() {
    return String.format("daml.marketplace.interface$.profilemanager.service.UpdateProfile(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
