...
public class RequestCreateUserProfile extends DamlRecord<RequestCreateUserProfile> {
  ...
  public static ValueDecoder<RequestCreateUserProfile> valueDecoder() throws
    ...
    return value$ -> {
      ...
      return new RequestCreateUserProfile(id, username, firstName, lastName, fullName, birthday,
  ...
  public static JsonLfDecoder<RequestCreateUserProfile> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("id", "username", "firstName", "lastName", "fullName", "birthday", "gender", "nationality", "contactMail", "cellphoneNumber", "taxId", "socialSecurityId", "observers"), name -> {
          switch (name) {
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.profilemanager.service.RequestCreateUserProfile(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        this.id, this.username, this.firstName, this.lastName, this.fullName, this.birthday,
        this.gender, this.nationality, this.contactMail, this.cellphoneNumber, this.taxId,
        this.socialSecurityId, this.observers);
  }
}
