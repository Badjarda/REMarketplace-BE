...
public class UpdateContactMail extends DamlRecord<UpdateContactMail> {
  ...
  public UpdateContactMail(String newContactMail, UserProfileKey userProfileKey) {
   ...
   */
  @Deprecated
  public static UpdateContactMail fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<UpdateContactMail> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new UpdateContactMail(newContactMail, userProfileKey);
    } ;
  }
  ...
  public static JsonLfDecoder<UpdateContactMail> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("newContactMail", "userProfileKey"), name -> {
        ...
        , (Object[] args) -> new UpdateContactMail(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1])));
  }

  public static UpdateContactMail fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof UpdateContactMail)) {
      return false;
    }
    UpdateContactMail other = (UpdateContactMail) object;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.newContactMail, this.userProfileKey);
  }
