...
public class View extends DamlRecord<View> {
  ...
  public View(String operator, String user, Id id, String description, Controllers controllers,
  ...
  public static ValueDecoder<View> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new View(operator, user, id, description, controllers, observers);
    } ;
  }
