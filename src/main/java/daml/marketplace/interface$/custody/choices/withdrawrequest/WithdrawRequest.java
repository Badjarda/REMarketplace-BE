...
public final class WithdrawRequest {
  public static final Identifier TEMPLATE_ID = new Identifier("0d9ec89bad8d531192667801b2000705bd418a72539b23331a355e1e2c1609a4", "Interface.Custody.Choices.WithdrawRequest", "WithdrawRequest");
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<WithdrawRequest> implements Exercises<ExerciseCommand> {
    ...
    @Override
    protected ContractTypeCompanion<? extends Contract<ContractId, ?>, ContractId, WithdrawRequest, ?> getCompanion(
        ) {
      return INTERFACE;
    }
  }
