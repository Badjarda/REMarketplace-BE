...
public final class OpenAccountRequest {
  public static final Identifier TEMPLATE_ID = new Identifier("8c6e592f5a33911df4c5cbfd683c840613ba80718b2d85f183257ac23495fc1f", "Interface.Custody.Choices.OpenAccountRequest", "OpenAccountRequest");
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<OpenAccountRequest> implements Exercises<ExerciseCommand> {
    ...
    @Override
    protected ContractTypeCompanion<? extends Contract<ContractId, ?>, ContractId, OpenAccountRequest, ?> getCompanion(
        ) {
      return INTERFACE;
    }
  }
