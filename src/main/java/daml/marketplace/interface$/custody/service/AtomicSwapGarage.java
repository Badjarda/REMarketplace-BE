...
public class AtomicSwapGarage extends DamlRecord<AtomicSwapGarage> {
  ...
  public static ValueDecoder<AtomicSwapGarage> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new AtomicSwapGarage(seller, buyer, sellerAccount, transferableHoldingCid,
  ...
  public static JsonLfDecoder<AtomicSwapGarage> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("seller", "buyer", "sellerAccount", "transferableHoldingCid", "transferRequestCid", "propertyKey"), name -> {
        ...
        , (Object[] args) -> new AtomicSwapGarage(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3]), JsonLfDecoders.cast(args[4]), JsonLfDecoders.cast(args[5])));
  }
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.custody.service.AtomicSwapGarage(%s, %s, %s, %s, %s, %s)",
