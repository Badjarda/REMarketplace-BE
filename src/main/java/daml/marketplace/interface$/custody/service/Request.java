...
public final class Request {
  public static final Identifier TEMPLATE_ID = new Identifier("b93cea58d2cd7e7792117719e7c79bd5a10ca2a87dc57a03f202a3ec5bc6c5d9", "Interface.Custody.Service", "Request");
  ...
  public interface Exercises<Cmd> extends com.daml.ledger.javaapi.data.codegen.Exercises.Archive<Cmd> {
    ...
    default Update<Exercised<Service.ContractId>> exerciseApprove(String operator,
      ...
      return exerciseApprove(new Approve(operator, accountFactoryCid, holdingFactoryKey,
          claimRuleCid));
    }
  }
  ...
  public static final class INTERFACE_ extends InterfaceCompanion<Request, ContractId, RView> {
    INTERFACE_() {
      super(
            "daml.marketplace.interface$.custody.service.Request", Request.TEMPLATE_ID, ContractId::new, RView.valueDecoder(),
