...
public class AtomicSwapWarehouse extends DamlRecord<AtomicSwapWarehouse> {
  ...
  public static ValueDecoder<AtomicSwapWarehouse> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new AtomicSwapWarehouse(seller, buyer, sellerAccount, transferRequestCid, propertyKey);
    } ;
  }
  ...
  public static JsonLfDecoder<AtomicSwapWarehouse> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("seller", "buyer", "sellerAccount", "transferRequestCid", "propertyKey"), name -> {
        ...
        , (Object[] args) -> new AtomicSwapWarehouse(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3]), JsonLfDecoders.cast(args[4])));
  }
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.custody.service.AtomicSwapWarehouse(%s, %s, %s, %s, %s)",
