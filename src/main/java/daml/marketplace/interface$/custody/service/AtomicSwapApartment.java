...
public class AtomicSwapApartment extends DamlRecord<AtomicSwapApartment> {
  ...
  public static ValueDecoder<AtomicSwapApartment> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new AtomicSwapApartment(seller, buyer, sellerAccount, transferableHoldingCid,
  ...
  public static JsonLfDecoder<AtomicSwapApartment> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("seller", "buyer", "sellerAccount", "transferableHoldingCid", "transferRequestCid", "propertyKey"), name -> {
        ...
        , (Object[] args) -> new AtomicSwapApartment(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3]), JsonLfDecoders.cast(args[4]), JsonLfDecoders.cast(args[5])));
  }
