...
public class AtomicSwapApartment extends DamlRecord<AtomicSwapApartment> {
  ...
  public AtomicSwapApartment(String seller, String buyer, AccountKey sellerAccount,
   ...
   */
  @Deprecated
  public static AtomicSwapApartment fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<AtomicSwapApartment> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new AtomicSwapApartment(seller, buyer, sellerAccount, transferRequestCid, propertyKey);
    } ;
  }
  ...
  public static JsonLfDecoder<AtomicSwapApartment> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("seller", "buyer", "sellerAccount", "transferRequestCid", "propertyKey"), name -> {
        ...
        , (Object[] args) -> new AtomicSwapApartment(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3]), JsonLfDecoders.cast(args[4])));
  }

  public static AtomicSwapApartment fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof AtomicSwapApartment)) {
      return false;
    }
    AtomicSwapApartment other = (AtomicSwapApartment) object;
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.custody.service.AtomicSwapApartment(%s, %s, %s, %s, %s)",
