...
public class AtomicSwapResidence extends DamlRecord<AtomicSwapResidence> {
  ...
  public static ValueDecoder<AtomicSwapResidence> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new AtomicSwapResidence(seller, buyer, sellerAccount, transferableHoldingCid,
  ...
  public static JsonLfDecoder<AtomicSwapResidence> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("seller", "buyer", "sellerAccount", "transferableHoldingCid", "transferRequestCid", "propertyKey"), name -> {
        ...
        , (Object[] args) -> new AtomicSwapResidence(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3]), JsonLfDecoders.cast(args[4]), JsonLfDecoders.cast(args[5])));
  }
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.custody.service.AtomicSwapResidence(%s, %s, %s, %s, %s, %s)",
