...
public class AtomicSwapLand extends DamlRecord<AtomicSwapLand> {
  ...
  public static ValueDecoder<AtomicSwapLand> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new AtomicSwapLand(seller, buyer, sellerAccount, transferableHoldingCid,
  ...
  public static JsonLfDecoder<AtomicSwapLand> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("seller", "buyer", "sellerAccount", "transferableHoldingCid", "transferRequestCid", "propertyKey"), name -> {
        ...
        , (Object[] args) -> new AtomicSwapLand(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3]), JsonLfDecoders.cast(args[4]), JsonLfDecoders.cast(args[5])));
  }
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.custody.service.AtomicSwapLand(%s, %s, %s, %s, %s, %s)",
