...
public class AtomicSwapLand extends DamlRecord<AtomicSwapLand> {
  ...
  public AtomicSwapLand(String seller, String buyer, AccountKey sellerAccount,
   ...
   */
  @Deprecated
  public static AtomicSwapLand fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<AtomicSwapLand> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new AtomicSwapLand(seller, buyer, sellerAccount, transferRequestCid, propertyKey);
    } ;
  }
  ...
  public static JsonLfDecoder<AtomicSwapLand> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("seller", "buyer", "sellerAccount", "transferRequestCid", "propertyKey"), name -> {
        ...
        , (Object[] args) -> new AtomicSwapLand(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3]), JsonLfDecoders.cast(args[4])));
  }

  public static AtomicSwapLand fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof AtomicSwapLand)) {
      return false;
    }
    AtomicSwapLand other = (AtomicSwapLand) object;
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.custody.service.AtomicSwapLand(%s, %s, %s, %s, %s)",
