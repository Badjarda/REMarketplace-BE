...
public class AtomicSwap extends DamlRecord<AtomicSwap> {
  ...
  public final TransferRequest.ContractId transferRequestCid;

  public AtomicSwap(String seller, String buyer, AccountKey sellerAccount,
   ...
   */
  @Deprecated
  public static AtomicSwap fromValue(Value value$) throws IllegalArgumentException {
  ...
  public static ValueDecoder<AtomicSwap> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      TransferRequest.ContractId transferRequestCid =
          new TransferRequest.ContractId(fields$.get(4).getValue().asContractId().orElseThrow(() -> new IllegalArgumentException("Expected transferRequestCid to be of type com.daml.ledger.javaapi.data.ContractId")).getValue());
      return new AtomicSwap(seller, buyer, sellerAccount, transferableHoldingCid,
          transferRequestCid);
    } ;
  }
  ...
  public static JsonLfDecoder<AtomicSwap> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("seller", "buyer", "sellerAccount", "transferableHoldingCid", "transferRequestCid"), name -> {
          switch (name) {
            ...
            case "transferRequestCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(4, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(daml.interface$.custody.choices.transferrequest.TransferRequest.ContractId::new));
            default: return null;
          }
        }
        , (Object[] args) -> new AtomicSwap(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3]), JsonLfDecoders.cast(args[4])));
  }
  ...
  public int hashCode() {
    return Objects.hash(this.seller, this.buyer, this.sellerAccount, this.transferableHoldingCid,
        this.transferRequestCid);
  }

  @Override
  public String toString() {
    return String.format("daml.interface$.custody.service.AtomicSwap(%s, %s, %s, %s, %s)",
