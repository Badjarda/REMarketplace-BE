...
public final class Removable {
  public static final Identifier TEMPLATE_ID = new Identifier("8b6e58552ef878dbcd4586daf541e0ca6dd1b0d75795e7f9ece68259cb3242b1", "Interface.Common.Removable", "Removable");
  ...
  public static final Choice<Removable, daml.da.internal.template.Archive, Unit> CHOICE_Archive = 
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Removable> implements Exercises<ExerciseCommand> {
    public ContractId(String contractId) {
      super(contractId);
    }

    @Override
    protected ContractTypeCompanion<? extends Contract<ContractId, ?>, ContractId, Removable, ?> getCompanion(
        ) {
      return INTERFACE;
    }
  }
