...
public final class Reference extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("b93cea58d2cd7e7792117719e7c79bd5a10ca2a87dc57a03f202a3ec5bc6c5d9", "Interface.RoleManager.UserRole.UserRole", "Reference");
  ...
  public static final Choice<Reference, GetCid, UserRole.ContractId> CHOICE_GetCid = 
  ...
  public final View userRoleView;

  public final UserRole.ContractId cid;

  public final Map<String, Set<String>> observers;

  public Reference(View userRoleView, UserRole.ContractId cid, Map<String, Set<String>> observers) {
   ...
   */
  @Deprecated
  public static Update<Exercised<ContractId>> exerciseByKeySetCid(UserRoleKey key, SetCid arg) {
   ...
   */
  @Deprecated
  public static Update<Exercised<ContractId>> exerciseByKeySetCid(UserRoleKey key,
      UserRole.ContractId newCid) {
   ...
   */
  @Deprecated
  public static Update<Exercised<ContractId>> exerciseByKeySetObservers(UserRoleKey key,
      SetObservers arg) {
   ...
   */
  @Deprecated
  public static Update<Exercised<Unit>> exerciseByKeyArchive(UserRoleKey key,
   ...
   */
  @Deprecated
  public static Update<Exercised<UserRole.ContractId>> exerciseByKeyGetCid(UserRoleKey key,
      GetCid arg) {
   ...
   */
  @Deprecated
  public Update<Exercised<ContractId>> createAndExerciseSetCid(UserRole.ContractId newCid) {
   ...
   */
  @Deprecated
  public Update<Exercised<UserRole.ContractId>> createAndExerciseGetCid(GetCid arg) {
   ...
   */
  @Deprecated
  public Update<Exercised<UserRole.ContractId>> createAndExerciseGetCid(String viewer) {
    return createAndExerciseGetCid(new GetCid(viewer));
  }

  public static Update<Created<ContractId>> create(View userRoleView, UserRole.ContractId cid,
      Map<String, Set<String>> observers) {
    return new Reference(userRoleView, cid, observers).create();
  }
  ...
  @Override
  protected ContractCompanion.WithKey<Contract, ContractId, Reference, UserRoleKey> getCompanion() {
    return COMPANION;
  }
  ...
  public DamlRecord toValue() {
    ...
    fields.add(new DamlRecord.Field("userRoleView", this.userRoleView.toValue()));
  ...
  private static ValueDecoder<Reference> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      View userRoleView = View.valueDecoder().decode(fields$.get(0).getValue());
      UserRole.ContractId cid =
          new UserRole.ContractId(fields$.get(1).getValue().asContractId().orElseThrow(() -> new IllegalArgumentException("Expected cid to be of type com.daml.ledger.javaapi.data.ContractId")).getValue());
      Map<String, Set<String>> observers = PrimitiveValueDecoders.fromGenMap(
            PrimitiveValueDecoders.fromText,
            Set.<java.lang.String>valueDecoder(PrimitiveValueDecoders.fromParty))
          .decode(fields$.get(2).getValue());
      return new Reference(userRoleView, cid, observers);
    } ;
  }
  ...
  public JsonLfEncoder jsonEncoder() {
    return JsonLfEncoders.record(
        JsonLfEncoders.Field.of("userRoleView", apply(View::jsonEncoder, userRoleView)),
  ...
  public boolean equals(Object object) {
    ...
    return Objects.equals(this.userRoleView, other.userRoleView) &&
        Objects.equals(this.cid, other.cid) && Objects.equals(this.observers, other.observers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.userRoleView, this.cid, this.observers);
  }
   ...
   */
  public static ByKey byKey(UserRoleKey key) {
  ...
  public static class Contract extends ContractWithKey<ContractId, Reference, UserRoleKey> {
    public Contract(ContractId id, Reference data, Optional<String> agreementText,
        Optional<UserRoleKey> key, java.util.Set<String> signatories,
    ...
    public static Contract fromIdAndRecord(String contractId, DamlRecord record$,
        Optional<String> agreementText, Optional<UserRoleKey> key,
  ...
  public interface Exercises<Cmd> extends com.daml.ledger.javaapi.data.codegen.Exercises.Archive<Cmd> {
    ...
    default Update<Exercised<ContractId>> exerciseSetCid(UserRole.ContractId newCid) {
    ...
    default Update<Exercised<UserRole.ContractId>> exerciseGetCid(GetCid arg) {
      return makeExerciseCmd(CHOICE_GetCid, arg);
    }

    default Update<Exercised<UserRole.ContractId>> exerciseGetCid(String viewer) {
