...
public final class Offer {
  public static final Identifier TEMPLATE_ID = new Identifier("0d9ec89bad8d531192667801b2000705bd418a72539b23331a355e1e2c1609a4", "Interface.Role.Operator", "Offer");
  ...
  public static final class INTERFACE_ extends InterfaceCompanion<Offer, ContractId, OView> {
    INTERFACE_() {
      super(
            "daml.marketplace.interface$.role.operator.Offer", Offer.TEMPLATE_ID, ContractId::new, OView.valueDecoder(),
