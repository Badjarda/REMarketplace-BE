...
public class View extends DamlRecord<View> {
  ...
  public View(String operator, Factory.ContractId userRoleFactoryCid) {
  ...
  public static ValueDecoder<View> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new View(operator, userRoleFactoryCid);
    } ;
  }
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.role.operator.View(%s, %s)", this.operator,
