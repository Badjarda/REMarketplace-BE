...
public class OView extends DamlRecord<OView> {
  ...
  public OView(String operator, String user) {
  ...
  public static ValueDecoder<OView> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new OView(operator, user);
    } ;
  }
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.role.user.OView(%s, %s)", this.operator, this.user);
  }
}
