...
public class OView extends DamlRecord<OView> {
  ...
  public OView(String user, String operator) {
    this.user = user;
  ...
  public static ValueDecoder<OView> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new OView(user, operator);
    } ;
  }
  ...
  public String toString() {
    return String.format("daml.marketplace.interface$.issuance.service.OView(%s, %s)", this.user,
        this.operator);
  }
}
