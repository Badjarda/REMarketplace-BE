...
public final class IssueRequest {
  public static final Identifier TEMPLATE_ID = new Identifier("f8883c36e16696951f0e9312ee45dacca92b05226daf215a5159b95d1b1c4079", "Interface.Issuance.Choices.IssueRequest", "IssueRequest");
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<IssueRequest> implements Exercises<ExerciseCommand> {
    ...
    @Override
    protected ContractTypeCompanion<? extends Contract<ContractId, ?>, ContractId, IssueRequest, ?> getCompanion(
        ) {
      return INTERFACE;
    }
  }
