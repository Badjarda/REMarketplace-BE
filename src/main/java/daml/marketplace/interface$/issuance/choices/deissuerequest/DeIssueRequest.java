...
public final class DeIssueRequest {
  public static final Identifier TEMPLATE_ID = new Identifier("7410dc0c147f7a1f02e29af653f3db7c67fc88031d45c6c69171d322a8445411", "Interface.Issuance.Choices.DeIssueRequest", "DeIssueRequest");
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<DeIssueRequest> implements Exercises<ExerciseCommand> {
    ...
    @Override
    protected ContractTypeCompanion<? extends Contract<ContractId, ?>, ContractId, DeIssueRequest, ?> getCompanion(
        ) {
      return INTERFACE;
    }
  }
