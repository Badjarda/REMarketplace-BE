...
public class View extends DamlRecord<View> {
  ...
  public View(String operator, String provider, String user) {
  ...
  public static ValueDecoder<View> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      String provider = PrimitiveValueDecoders.fromParty.decode(fields$.get(1).getValue());
      String user = PrimitiveValueDecoders.fromParty.decode(fields$.get(2).getValue());
      return new View(operator, provider, user);
    } ;
  }
  ...
  public static JsonLfDecoder<View> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("operator", "provider", "user"), name -> {
          switch (name) {
            case "operator": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(0, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.party);
            case "provider": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(1, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.party);
            case "user": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(2, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.party);
            default: return null;
          }
        }
  ...
  public boolean equals(Object object) {
    ...
    return Objects.equals(this.operator, other.operator) &&
        Objects.equals(this.provider, other.provider) && Objects.equals(this.user, other.user);
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.operator, this.provider, this.user);
  }

  @Override
  public String toString() {
    return String.format("daml.marketplace.interface$.base.request.View(%s, %s, %s)", this.operator,
