...
public final class Offer {
  public static final Identifier TEMPLATE_ID = new Identifier("b93cea58d2cd7e7792117719e7c79bd5a10ca2a87dc57a03f202a3ec5bc6c5d9", "Interface.Base.Offer", "Offer");
  ...
  public static final Choice<Offer, Reject, Unit> CHOICE_Reject = 
      Choice.create("Reject", value$ -> value$.toValue(), value$ -> Reject.valueDecoder()
        .decode(value$), value$ -> PrimitiveValueDecoders.fromUnit.decode(value$));

  public static final Choice<Offer, Withdraw, Unit> CHOICE_Withdraw = 
  ...
  public static final class INTERFACE_ extends InterfaceCompanion<Offer, ContractId, View> {
    INTERFACE_() {
      super(
            "daml.marketplace.interface$.base.offer.Offer", Offer.TEMPLATE_ID, ContractId::new, View.valueDecoder(),
