...
public final class Offer extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("0d9ec89bad8d531192667801b2000705bd418a72539b23331a355e1e2c1609a4", "App.RoleManager.Service", "Offer");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Offer> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.marketplace.app.rolemanager.service.Offer", TEMPLATE_ID,
  ...
  public String toString() {
    return String.format("daml.marketplace.app.rolemanager.service.Offer(%s, %s, %s)", this.operator, this.user,
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Offer> implements Exercises<ExerciseCommand> {
    ...
    public daml.marketplace.interface$.rolemanager.service.Offer.ContractId toInterface(
        daml.marketplace.interface$.rolemanager.service.Offer.INTERFACE_ interfaceCompanion) {
      return new daml.marketplace.interface$.rolemanager.service.Offer.ContractId(this.contractId);
    }

    public static ContractId unsafeFromInterface(
        daml.marketplace.interface$.rolemanager.service.Offer.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.marketplace.interface$.rolemanager.service.Offer.CreateAnd toInterface(
        daml.marketplace.interface$.rolemanager.service.Offer.INTERFACE_ interfaceCompanion) {
      return new daml.marketplace.interface$.rolemanager.service.Offer.CreateAnd(COMPANION, this.createArguments);
    }
  }
}
