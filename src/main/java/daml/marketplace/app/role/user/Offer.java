...
public final class Offer extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("7410dc0c147f7a1f02e29af653f3db7c67fc88031d45c6c69171d322a8445411", "App.Role.User", "Offer");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Offer> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.app.role.user.Offer", TEMPLATE_ID, ContractId::new,
  ...
  public static JsonLfDecoder<Offer> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("operator", "user", "userRole"), name -> {
          switch (name) {
            ...
            case "userRole": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(2, daml.interface$.common.types.UserRoleKey.jsonDecoder());
            default: return null;
          }
        }
  ...
  public String toString() {
    return String.format("daml.app.role.user.Offer(%s, %s, %s)", this.operator, this.user,
        this.userRole);
  }
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Offer> implements Exercises<ExerciseCommand> {
    ...
    public daml.interface$.role.user.Offer.ContractId toInterface(
        daml.interface$.role.user.Offer.INTERFACE_ interfaceCompanion) {
      return new daml.interface$.role.user.Offer.ContractId(this.contractId);
    }

    public static ContractId unsafeFromInterface(
        daml.interface$.role.user.Offer.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.interface$.role.user.Offer.CreateAnd toInterface(
        daml.interface$.role.user.Offer.INTERFACE_ interfaceCompanion) {
      return new daml.interface$.role.user.Offer.CreateAnd(COMPANION, this.createArguments);
    }
  }
}
