...
public final class Offer extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("8c6e592f5a33911df4c5cbfd683c840613ba80718b2d85f183257ac23495fc1f", "App.Role.User", "Offer");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Offer> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.marketplace.app.role.user.Offer", TEMPLATE_ID, ContractId::new,
        v -> Offer.templateValueDecoder().decode(v), Offer::fromJson, Contract::new,
  ...
  public Offer(String operator, String user, UserRoleKey userRole) {
  ...
  public static Update<Created<ContractId>> create(String operator, String user,
    ...
    return new Offer(operator, user, userRole).create();
  }
  ...
  public DamlRecord toValue() {
    ...
    fields.add(new DamlRecord.Field("userRole", this.userRole.toValue()));
  ...
  private static ValueDecoder<Offer> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      UserRoleKey userRole = UserRoleKey.valueDecoder().decode(fields$.get(2).getValue());
      return new Offer(operator, user, userRole);
    } ;
  }

  public static JsonLfDecoder<Offer> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("operator", "user", "userRole"), name -> {
          switch (name) {
            ...
            case "userRole": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(2, daml.marketplace.interface$.common.types.UserRoleKey.jsonDecoder());
            default: return null;
          }
        }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.operator, this.user, this.userRole);
  }

  @Override
  public String toString() {
    return String.format("daml.marketplace.app.role.user.Offer(%s, %s, %s)", this.operator, this.user,
        this.userRole);
  }
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Offer> implements Exercises<ExerciseCommand> {
    ...
    public daml.marketplace.interface$.role.user.Offer.ContractId toInterface(
        daml.marketplace.interface$.role.user.Offer.INTERFACE_ interfaceCompanion) {
      return new daml.marketplace.interface$.role.user.Offer.ContractId(this.contractId);
    }

    public static ContractId unsafeFromInterface(
        daml.marketplace.interface$.role.user.Offer.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.marketplace.interface$.role.user.Offer.CreateAnd toInterface(
        daml.marketplace.interface$.role.user.Offer.INTERFACE_ interfaceCompanion) {
      return new daml.marketplace.interface$.role.user.Offer.CreateAnd(COMPANION, this.createArguments);
    }
  }
}
