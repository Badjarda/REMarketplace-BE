...
public final class Service extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("e09e7a18c217e8002e4a374c04915d394e5120e173ac8f1ee6decbc2d8c3c8b4", "App.ProfileManager.Service", "Service");
  ...
  public static final ContractCompanion.WithKey<Contract, ContractId, Service, Tuple2<String, String>> COMPANION = 
      new ContractCompanion.WithKey<>("daml.marketplace.app.profilemanager.service.Service", TEMPLATE_ID,
  ...
  public Service(String operator, String user, Factory.ContractId userProfileFactoryCid) {
  ...
  public static Update<Created<ContractId>> create(String operator, String user,
    ...
    return new Service(operator, user, userProfileFactoryCid).create();
  }
  ...
  public DamlRecord toValue() {
    ...
    fields.add(new DamlRecord.Field("userProfileFactoryCid", this.userProfileFactoryCid.toValue()));
  ...
  private static ValueDecoder<Service> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new Service(operator, user, userProfileFactoryCid);
    } ;
  }
  ...
  public static JsonLfDecoder<Service> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("operator", "user", "userProfileFactoryCid"), name -> {
          switch (name) {
            ...
            case "userProfileFactoryCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(2, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(daml.marketplace.interface$.profilemanager.userprofile.factory.Factory.ContractId::new));
            default: return null;
          }
        }
  ...
  public String toString() {
    return String.format("daml.marketplace.app.profilemanager.service.Service(%s, %s, %s)", this.operator,
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Service> implements Exercises<ExerciseCommand> {
    ...
    public daml.marketplace.interface$.profilemanager.service.Service.ContractId toInterface(
        daml.marketplace.interface$.profilemanager.service.Service.INTERFACE_ interfaceCompanion) {
      return new daml.marketplace.interface$.profilemanager.service.Service.ContractId(this.contractId);
    }
    ...
    public static ContractId unsafeFromInterface(
        daml.marketplace.interface$.profilemanager.service.Service.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.marketplace.interface$.profilemanager.service.Service.CreateAnd toInterface(
        daml.marketplace.interface$.profilemanager.service.Service.INTERFACE_ interfaceCompanion) {
      return new daml.marketplace.interface$.profilemanager.service.Service.CreateAnd(COMPANION, this.createArguments);
    }
  ...
  public static final class ByKey extends com.daml.ledger.javaapi.data.codegen.ByKey implements Exercises<ExerciseByKeyCommand> {
    ...
    public daml.marketplace.interface$.profilemanager.service.Service.ByKey toInterface(
        daml.marketplace.interface$.profilemanager.service.Service.INTERFACE_ interfaceCompanion) {
      return new daml.marketplace.interface$.profilemanager.service.Service.ByKey(COMPANION, this.contractKey);
    }
