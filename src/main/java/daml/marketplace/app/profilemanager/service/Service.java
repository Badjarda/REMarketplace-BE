...
public final class Service extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("7410dc0c147f7a1f02e29af653f3db7c67fc88031d45c6c69171d322a8445411", "App.ProfileManager.Service", "Service");
  ...
  public static final ContractCompanion.WithKey<Contract, ContractId, Service, Tuple2<String, String>> COMPANION = 
      new ContractCompanion.WithKey<>("daml.app.profilemanager.service.Service", TEMPLATE_ID,
  ...
  public String toString() {
    return String.format("daml.app.profilemanager.service.Service(%s, %s, %s)", this.operator,
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Service> implements Exercises<ExerciseCommand> {
    ...
    public daml.interface$.profilemanager.service.Service.ContractId toInterface(
        daml.interface$.profilemanager.service.Service.INTERFACE_ interfaceCompanion) {
      return new daml.interface$.profilemanager.service.Service.ContractId(this.contractId);
    }
    ...
    public static ContractId unsafeFromInterface(
        daml.interface$.profilemanager.service.Service.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.interface$.profilemanager.service.Service.CreateAnd toInterface(
        daml.interface$.profilemanager.service.Service.INTERFACE_ interfaceCompanion) {
      return new daml.interface$.profilemanager.service.Service.CreateAnd(COMPANION, this.createArguments);
    }
  ...
  public static final class ByKey extends com.daml.ledger.javaapi.data.codegen.ByKey implements Exercises<ExerciseByKeyCommand> {
    ...
    public daml.interface$.profilemanager.service.Service.ByKey toInterface(
        daml.interface$.profilemanager.service.Service.INTERFACE_ interfaceCompanion) {
      return new daml.interface$.profilemanager.service.Service.ByKey(COMPANION, this.contractKey);
    }
