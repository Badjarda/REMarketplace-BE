...
public final class RequestCreateUserProfile extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("ab9bbdb36a2cfacb7b3bd66e0d472fb99ff4b9d98bdf81e76a5b8bd3b57250a9", "App.ProfileManager.Model", "RequestCreateUserProfile");
  ...
  public static final ContractCompanion.WithKey<Contract, ContractId, RequestCreateUserProfile, Tuple2<String, Id>> COMPANION = 
  ...
  public RequestCreateUserProfile(String operator, String user, Id id, String username,
      String firstName, String lastName, String fullName, LocalDate birthday,
  ...
  @Override
  protected ContractCompanion.WithKey<Contract, ContractId, RequestCreateUserProfile, Tuple2<String, Id>> getCompanion(
      ) {
    return COMPANION;
  }
  ...
  private static ValueDecoder<RequestCreateUserProfile> templateValueDecoder() throws
    ...
    return value$ -> {
      ...
      return new RequestCreateUserProfile(operator, user, id, username, firstName, lastName,
          fullName, birthday, gender, nationality, contactMail, cellphoneNumber, taxId,
  ...
  public String toString() {
    return String.format("daml.marketplace.app.profilemanager.model.RequestCreateUserProfile(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  public static class Contract extends ContractWithKey<ContractId, RequestCreateUserProfile, Tuple2<String, Id>> {
