...
public final class TransferRequest extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("7410dc0c147f7a1f02e29af653f3db7c67fc88031d45c6c69171d322a8445411", "App.Custody.Model", "TransferRequest");

  public static final Choice<TransferRequest, daml.da.internal.template.Archive, Unit> CHOICE_Archive = 
      Choice.create("Archive", value$ -> value$.toValue(), value$ ->
        daml.da.internal.template.Archive.valueDecoder().decode(value$), value$ ->
        PrimitiveValueDecoders.fromUnit.decode(value$));

  public static final ContractCompanion.WithoutKey<Contract, ContractId, TransferRequest> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.app.custody.model.TransferRequest", TEMPLATE_ID,
        ContractId::new, v -> TransferRequest.templateValueDecoder().decode(v),
        TransferRequest::fromJson, Contract::new, List.of(CHOICE_Archive));
  ...
  public TransferRequest(String operator, String buyer, String seller, AccountKey sellerAccount,
  ...
  public Update<Created<ContractId>> create() {
    return new Update.CreateUpdate<ContractId, Created<ContractId>>(new CreateCommand(TransferRequest.TEMPLATE_ID, this.toValue()), x -> x, ContractId::new);
  }
  ...
  public static Update<Created<ContractId>> create(String operator, String buyer, String seller,
    ...
    return new TransferRequest(operator, buyer, seller, sellerAccount, buyerAccount,
        fungibleHoldingCid).create();
  }
  ...
  @Override
  protected ContractCompanion.WithoutKey<Contract, ContractId, TransferRequest> getCompanion() {
    return COMPANION;
  }
   ...
   */
  @Deprecated
  public static TransferRequest fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<TransferRequest> valueDecoder() throws IllegalArgumentException {
  ...
  private static ValueDecoder<TransferRequest> templateValueDecoder() throws
  ...
  public static JsonLfDecoder<TransferRequest> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("operator", "buyer", "seller", "sellerAccount", "buyerAccount", "fungibleHoldingCid"), name -> {
          switch (name) {
        ...
        , (Object[] args) -> new TransferRequest(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1]), JsonLfDecoders.cast(args[2]), JsonLfDecoders.cast(args[3]), JsonLfDecoders.cast(args[4]), JsonLfDecoders.cast(args[5])));
  }

  public static TransferRequest fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public int hashCode() {
    return Objects.hash(this.operator, this.buyer, this.seller, this.sellerAccount,
        this.buyerAccount, this.fungibleHoldingCid);
  }

  @Override
  public String toString() {
    return String.format("daml.app.custody.model.TransferRequest(%s, %s, %s, %s, %s, %s)",
        this.operator, this.buyer, this.seller, this.sellerAccount, this.buyerAccount,
        this.fungibleHoldingCid);
  }

  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<TransferRequest> implements Exercises<ExerciseCommand> {
    public ContractId(String contractId) {
      super(contractId);
    }

    @Override
    protected ContractTypeCompanion<? extends com.daml.ledger.javaapi.data.codegen.Contract<ContractId, ?>, ContractId, TransferRequest, ?> getCompanion(
        ) {
      return COMPANION;
    }

    public daml.interface$.custody.choices.transferrequest.TransferRequest.ContractId toInterface(
        daml.interface$.custody.choices.transferrequest.TransferRequest.INTERFACE_ interfaceCompanion) {
      return new daml.interface$.custody.choices.transferrequest.TransferRequest.ContractId(this.contractId);
    }
    ...
    public static ContractId unsafeFromInterface(
        daml.interface$.custody.choices.transferrequest.TransferRequest.ContractId interfaceContractId) {
    ...
    public static ContractId fromContractId(
        com.daml.ledger.javaapi.data.codegen.ContractId<TransferRequest> contractId) {
      return COMPANION.toContractId(contractId);
    }
  }

  public static class Contract extends com.daml.ledger.javaapi.data.codegen.Contract<ContractId, TransferRequest> {
    public Contract(ContractId id, TransferRequest data, Optional<String> agreementText,
        Set<String> signatories, Set<String> observers) {
      super(id, data, agreementText, signatories, observers);
    }

    @Override
    protected ContractCompanion<Contract, ContractId, TransferRequest> getCompanion() {
      return COMPANION;
    }
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.interface$.custody.choices.transferrequest.TransferRequest.CreateAnd toInterface(
        daml.interface$.custody.choices.transferrequest.TransferRequest.INTERFACE_ interfaceCompanion) {
      return new daml.interface$.custody.choices.transferrequest.TransferRequest.CreateAnd(COMPANION, this.createArguments);
    }
