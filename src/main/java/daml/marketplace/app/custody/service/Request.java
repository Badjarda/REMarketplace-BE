...
public final class Request extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("8b6e58552ef878dbcd4586daf541e0ca6dd1b0d75795e7f9ece68259cb3242b1", "App.Custody.Service", "Request");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Request> COMPANION = 
      new ContractCompanion.WithoutKey<>("daml.marketplace.app.custody.service.Request", TEMPLATE_ID,
  ...
  public String toString() {
    return String.format("daml.marketplace.app.custody.service.Request(%s, %s)", this.user, this.operator);
  }
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Request> implements Exercises<ExerciseCommand> {
    ...
    public daml.marketplace.interface$.custody.service.Request.ContractId toInterface(
        daml.marketplace.interface$.custody.service.Request.INTERFACE_ interfaceCompanion) {
      return new daml.marketplace.interface$.custody.service.Request.ContractId(this.contractId);
    }

    public static ContractId unsafeFromInterface(
        daml.marketplace.interface$.custody.service.Request.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.marketplace.interface$.custody.service.Request.CreateAnd toInterface(
        daml.marketplace.interface$.custody.service.Request.INTERFACE_ interfaceCompanion) {
      return new daml.marketplace.interface$.custody.service.Request.CreateAnd(COMPANION, this.createArguments);
    }
  }
}
