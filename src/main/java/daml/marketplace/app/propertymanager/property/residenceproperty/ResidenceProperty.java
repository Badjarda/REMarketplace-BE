...
public final class ResidenceProperty extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("7410dc0c147f7a1f02e29af653f3db7c67fc88031d45c6c69171d322a8445411", "App.PropertyManager.Property.ResidenceProperty", "ResidenceProperty");
  ...
  public static Update<Created<ContractId>> create(String operator, String user, Id id,
      InstrumentKey instrument, BigDecimal residencePrice, String propertyAddress,
    ...
    return new ResidenceProperty(operator, user, id, instrument, residencePrice, propertyAddress,
  ...
  public String toString() {
    return String.format("daml.app.propertymanager.property.residenceproperty.ResidenceProperty(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
