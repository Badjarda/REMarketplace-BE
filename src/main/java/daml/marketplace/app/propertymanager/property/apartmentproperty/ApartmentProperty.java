...
public final class ApartmentProperty extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("f8883c36e16696951f0e9312ee45dacca92b05226daf215a5159b95d1b1c4079", "App.PropertyManager.Property.ApartmentProperty", "ApartmentProperty");
  ...
  public static final ContractCompanion.WithKey<Contract, ContractId, ApartmentProperty, Tuple3<String, String, Id>> COMPANION = 
  ...
  public Update<Created<ContractId>> create() {
    return new Update.CreateUpdate<ContractId, Created<ContractId>>(new CreateCommand(ApartmentProperty.TEMPLATE_ID, this.toValue()), x -> x, ContractId::new);
  }
  ...
  public static Update<Created<ContractId>> create(String operator, String user, Id id,
    ...
    return new ApartmentProperty(operator, user, id, instrument, apartmentPrice, propertyAddress,
        ...
        additionalInformation, description, photoReferences, observers).create();
  }
  ...
  @Override
  protected ContractCompanion.WithKey<Contract, ContractId, ApartmentProperty, Tuple3<String, String, Id>> getCompanion(
      ) {
    return COMPANION;
  }
   ...
   */
  @Deprecated
  public static ApartmentProperty fromValue(Value value$) throws IllegalArgumentException {
    return valueDecoder().decode(value$);
  }

  public static ValueDecoder<ApartmentProperty> valueDecoder() throws IllegalArgumentException {
  ...
  private static ValueDecoder<ApartmentProperty> templateValueDecoder() throws
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof ApartmentProperty)) {
      return false;
    }
  ...
  public String toString() {
    return String.format("daml.marketplace.app.propertymanager.property.apartmentproperty.ApartmentProperty(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<ApartmentProperty> implements Exercises<ExerciseCommand> {
    ...
    @Override
    protected ContractTypeCompanion<? extends com.daml.ledger.javaapi.data.codegen.Contract<ContractId, ?>, ContractId, ApartmentProperty, ?> getCompanion(
        ) {
      return COMPANION;
    }
    ...
    public static ContractId fromContractId(
        com.daml.ledger.javaapi.data.codegen.ContractId<ApartmentProperty> contractId) {
      return COMPANION.toContractId(contractId);
    }
  }

  public static class Contract extends ContractWithKey<ContractId, ApartmentProperty, Tuple3<String, String, Id>> {
    public Contract(ContractId id, ApartmentProperty data, Optional<String> agreementText,
    ...
    @Override
    protected ContractCompanion<Contract, ContractId, ApartmentProperty> getCompanion() {
      return COMPANION;
    }
