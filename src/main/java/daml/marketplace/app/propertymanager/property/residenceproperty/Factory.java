...
public final class Factory extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("7410dc0c147f7a1f02e29af653f3db7c67fc88031d45c6c69171d322a8445411", "App.PropertyManager.Property.ResidenceProperty", "Factory");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Factory> COMPANION = 
      new ContractCompanion.WithoutKey<>(
        "daml.app.propertymanager.property.residenceproperty.Factory", TEMPLATE_ID, ContractId::new,
  ...
  public String toString() {
    return String.format("daml.app.propertymanager.property.residenceproperty.Factory(%s, %s)",
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Factory> implements Exercises<ExerciseCommand> {
    ...
    public daml.interface$.propertymanager.property.residenceproperty.factory.Factory.ContractId toInterface(
        daml.interface$.propertymanager.property.residenceproperty.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new daml.interface$.propertymanager.property.residenceproperty.factory.Factory.ContractId(this.contractId);
    }
    ...
    public static ContractId unsafeFromInterface(
        daml.interface$.propertymanager.property.residenceproperty.factory.Factory.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.interface$.propertymanager.property.residenceproperty.factory.Factory.CreateAnd toInterface(
        daml.interface$.propertymanager.property.residenceproperty.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new daml.interface$.propertymanager.property.residenceproperty.factory.Factory.CreateAnd(COMPANION, this.createArguments);
    }
