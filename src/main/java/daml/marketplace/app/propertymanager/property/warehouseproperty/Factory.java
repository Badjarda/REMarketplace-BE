...
public final class Factory extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("ab9bbdb36a2cfacb7b3bd66e0d472fb99ff4b9d98bdf81e76a5b8bd3b57250a9", "App.PropertyManager.Property.WarehouseProperty", "Factory");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Factory> COMPANION = 
      new ContractCompanion.WithoutKey<>(
        "daml.marketplace.app.propertymanager.property.warehouseproperty.Factory", TEMPLATE_ID, ContractId::new,
        v -> Factory.templateValueDecoder().decode(v), Factory::fromJson, Contract::new,
  ...
  public Factory(String operator, Map<String, Set<String>> observers) {
  ...
  public static Update<Created<ContractId>> create(String operator,
    ...
    return new Factory(operator, observers).create();
  }
  ...
  private static ValueDecoder<Factory> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      return new Factory(operator, observers);
    } ;
  }

  public static JsonLfDecoder<Factory> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("operator", "observers"), name -> {
          switch (name) {
        ...
        , (Object[] args) -> new Factory(JsonLfDecoders.cast(args[0]), JsonLfDecoders.cast(args[1])));
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(this.operator, this.observers);
  }

  @Override
  public String toString() {
    return String.format("daml.marketplace.app.propertymanager.property.warehouseproperty.Factory(%s, %s)",
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Factory> implements Exercises<ExerciseCommand> {
    ...
    public daml.marketplace.interface$.propertymanager.property.warehouseproperty.factory.Factory.ContractId toInterface(
        daml.marketplace.interface$.propertymanager.property.warehouseproperty.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new daml.marketplace.interface$.propertymanager.property.warehouseproperty.factory.Factory.ContractId(this.contractId);
    }
    ...
    public static ContractId unsafeFromInterface(
        daml.marketplace.interface$.propertymanager.property.warehouseproperty.factory.Factory.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public daml.marketplace.interface$.propertymanager.property.warehouseproperty.factory.Factory.CreateAnd toInterface(
        daml.marketplace.interface$.propertymanager.property.warehouseproperty.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new daml.marketplace.interface$.propertymanager.property.warehouseproperty.factory.Factory.CreateAnd(COMPANION, this.createArguments);
    }
